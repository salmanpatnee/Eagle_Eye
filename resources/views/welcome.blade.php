...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .aurora-1 {
            background: radial-gradient(circle, rgba(37, 99, 235, 0.14) 0%, rgba(37, 99, 235, 0.05) 48%, transparent 70%);
        }

        .aurora-2 {
            background: radial-gradient(circle, rgba(14, 165, 233, 0.11) 0%, rgba(14, 165, 233, 0.03) 48%, transparent 70%);
        }
        ...
        .feature-card.fc-violet::before {
            background: linear-gradient(90deg, #7C3AED, #A78BFA);
        }

        .feature-card.fc-teal::before {
            background: linear-gradient(90deg, #0EA5E9, #34D399);
        }

        .feature-card.fc-emerald::before {
            background: linear-gradient(90deg, #059669, #34D399);
        }

        .feature-card.fc-rose::before {
            background: linear-gradient(90deg, #E11D48, #FB7185);
        }

        .feature-card.fc-amber .feature-icon-wrap {
            background: #FEF3C7;
            border-color: rgba(217, 119, 6, 0.28);
        }

        .feature-card.fc-violet .feature-icon-wrap {
            background: #EDE9FE;
            border-color: rgba(124, 58, 237, 0.25);
        }

        .feature-card.fc-teal .feature-icon-wrap {
            background: #E0F2FE;
            border-color: rgba(14, 165, 233, 0.25);
        }

        .feature-card.fc-emerald .feature-icon-wrap {
            background: #D1FAE5;
            border-color: rgba(5, 150, 105, 0.22);
        }

        .feature-card.fc-rose .feature-icon-wrap {
            background: #FFF1F2;
        ...
        .feature-card.fc-amber {
            background: linear-gradient(155deg, #FFFBEB 0%, #fff 55%);
        }

        .feature-card.fc-rose {
            background: linear-gradient(155deg, #FFF1F2 0%, #fff 55%);
        }

        .feature-card.fc-violet {
            background: linear-gradient(155deg, #F5F3FF 0%, #fff 55%);
        }

        .feature-card.fc-blue {
            background: linear-gradient(155deg, #EFF6FF 0%, #fff 55%);
        }
        ...
        .feature-card.fc-emerald {
            background: linear-gradient(155deg, #ECFDF5 0%, #fff 55%);
        }
        ...
        .feature-card.fc-amber:hover {
            border-color: rgba(217, 119, 6, 0.35);
        }

        .feature-card.fc-rose:hover {
            border-color: rgba(225, 29, 72, 0.3);
        }

        .feature-card.fc-violet:hover {
            border-color: rgba(124, 58, 237, 0.3);
        }

        .feature-card.fc-teal:hover {
            border-color: rgba(14, 165, 233, 0.3);
        }

        .feature-card.fc-emerald:hover {
        ...
        .stat-item:nth-child(1) {
            --stat-glow: rgba(37, 99, 235, 0.18);
        }

        .stat-item:nth-child(2) {
            --stat-glow: rgba(14, 165, 233, 0.18);
        }

        .stat-item:nth-child(3) {
            --stat-glow: rgba(124, 58, 237, 0.18);
        }
        ...
        .trust-badge.tb-emerald {
            background: rgba(16, 185, 129, 0.09);
            border-color: rgba(16, 185, 129, 0.3);
            color: #059669;
        }

        .trust-badge.tb-amber {
        ...
        .cv-fw-tl {
            top: 20px;
            left: 2px;
            animation: cv-badge-in 0.45s ease 1.8s forwards, cv-float-up 7s ease-in-out 2.4s infinite;
        }

        .cv-fw-tr {
            top: 20px;
            right: 2px;
            animation: cv-badge-in 0.45s ease 2.05s forwards, cv-float-up 7s ease-in-out 2.65s infinite;
        }

        .cv-fw-bl {
            bottom: 16px;
            left: 2px;
            animation: cv-badge-in 0.45s ease 2.3s forwards, cv-float-dn 7s ease-in-out 2.9s infinite;
        }

        .cv-fw-br {
            bottom: 16px;
            right: 2px;
            animation: cv-badge-in 0.45s ease 2.55s forwards, cv-float-dn 7s ease-in-out 3.15s infinite;
        }
                ...
                <div class="hero-content">
                    ...
                    <div class="hero-announce anim-5">
                        <svg class="hero-announce-icon" width="14" height="14" viewBox="0 0 14 14" fill="none"
                            aria-hidden="true">
                            <path d="M7 1L13 7L7 13L1 7L7 1Z" stroke="#2563EB" stroke-width="1.5"
                                stroke-linejoin="round" />
                            <circle cx="7" cy="7" r="2" fill="#2563EB" />
                        </svg>
                        <span class="hero-announce-text">Eagle Eye is now proudly part of Flexshield Solution, a
                            subsidiary of Ethara Holding. This marks a significant strengthening of our ties with
                            <strong><a href="https://ethraaholding.com.sa/en/" target="_blank"
                                    rel="noopener noreferrer">Ethara Holding</a></strong>. <a
                                href="https://ethraaholding.com.sa/en/" target="_blank"
                                rel="noopener noreferrer">https://ethraaholding.com.sa/en/</a></span>
                    </div>
                ...
                <div class="hero-visual">
                    <div class="compliance-viz">
                        ...
                        <div class="cv-ring-wrap">
                            ...
                            <svg class="cv-ring-svg" viewBox="0 0 240 240" role="img"
                                aria-label="100% GRC Compliance Score">
                                <defs>
                                    <linearGradient id="cvRingGrad" x1="0%" y1="0%" x2="100%"
                                        y2="100%">
                                ...
                                <text x="120" y="14" text-anchor="middle" font-size="10"
                                    fill="rgba(52,211,153,0.7)">✦</text>
                                <text x="120" y="236" text-anchor="middle" font-size="10"
                                    fill="rgba(52,211,153,0.7)">✦</text>
                                <text x="232" y="125" text-anchor="middle" font-size="9"
                                    fill="rgba(52,211,153,0.7)">✦</text>
                                <text x="8" y="125" text-anchor="middle" font-size="9"
                                    fill="rgba(52,211,153,0.7)">✦</text>
                                ...
                                <text font-family="'Bricolage Grotesque', sans-serif" font-size="9"
                                    font-weight="700" fill="rgba(52,211,153,0.72)" letter-spacing="2.5">
                                    <textPath href="#cvBotArc" startOffset="50%" text-anchor="middle"
                                        side="right">CERTIFIED · 100% COMPLIANT ·</textPath>
                                </text>
                                ...
                                <text x="120" y="108" text-anchor="middle"
                                    font-family="'Bricolage Grotesque', sans-serif" font-size="48" font-weight="800"
            ...
            <div class="infographics-grid">
                ...
                <div class="ig-panel reveal">
                    ...
                    <div style="display:flex;gap:4px;align-items:flex-start;">
                        <!-- Y-axis (likelihood) -->
                        <div
                            style="display:flex;flex-direction:column;justify-content:space-around;height:172px;padding:4px 0;gap:0;flex-shrink:0;">
                            <span
                                style="font-size:8px;color:#94A3B8;font-family:'JetBrains Mono',monospace;width:32px;text-align:right;line-height:33px;">V.Hi</span>
                            <span
                                style="font-size:8px;color:#94A3B8;font-family:'JetBrains Mono',monospace;width:32px;text-align:right;line-height:33px;">Hi</span>
                            <span
                                style="font-size:8px;color:#94A3B8;font-family:'JetBrains Mono',monospace;width:32px;text-align:right;line-height:33px;">Med</span>
                            <span
                                style="font-size:8px;color:#94A3B8;font-family:'JetBrains Mono',monospace;width:32px;text-align:right;line-height:33px;">Low</span>
                            <span
                                style="font-size:8px;color:#94A3B8;font-family:'JetBrains Mono',monospace;width:32px;text-align:right;line-height:33px;">V.Lo</span>
                        </div>
                        <div style="flex:1;">
                            <!-- X-axis labels -->
                            <div style="display:flex;margin-bottom:3px;padding:0 2px;">
                                <span
                                    style="flex:1;font-size:8px;color:#94A3B8;font-family:'JetBrains Mono',monospace;text-align:center;">Low</span>
                                <span
                                    style="flex:1;font-size:8px;color:#94A3B8;font-family:'JetBrains Mono',monospace;text-align:center;">Med</span>
                                <span
                                    style="flex:1;font-size:8px;color:#94A3B8;font-family:'JetBrains Mono',monospace;text-align:center;">High</span>
                                <span
                                    style="flex:1;font-size:8px;color:#94A3B8;font-family:'JetBrains Mono',monospace;text-align:center;">V.Hi</span>
                                <span
                                    style="flex:1;font-size:8px;color:#94A3B8;font-family:'JetBrains Mono',monospace;text-align:center;">Crit</span>
                            </div>
                            <!-- 5×5 heatmap: row=likelihood top→VHigh, col=impact left→Low -->
                            <svg viewBox="0 0 205 165" width="100%" role="img"
                                aria-label="5x5 risk heatmap: likelihood vs impact">
                                <defs>
                                    <filter id="hm-shadow">
                                ...
                                <rect x="1" y="1" width="37" height="31" rx="5" fill="#FCA5A5"
                                    filter="url(#hm-shadow)" />
                                <rect x="42" y="1" width="37" height="31" rx="5" fill="#EF4444"
                                    filter="url(#hm-shadow)" />
                                <rect x="83" y="1" width="37" height="31" rx="5" fill="#DC2626"
                                    filter="url(#hm-shadow)" />
                                <rect x="124" y="1" width="37" height="31" rx="5" fill="#B91C1C"
                                    filter="url(#hm-shadow)" />
                                <rect x="165" y="1" width="37" height="31" rx="5" fill="#7F1D1D"
                                    filter="url(#hm-shadow)" />
                                <!-- Row 2 = High likelihood -->
                                <rect x="1" y="34" width="37" height="31" rx="5" fill="#FDE68A"
                                    filter="url(#hm-shadow)" />
                                <rect x="42" y="34" width="37" height="31" rx="5" fill="#FCA5A5"
                                    filter="url(#hm-shadow)" />
                                <rect x="83" y="34" width="37" height="31" rx="5" fill="#EF4444"
                                    filter="url(#hm-shadow)" />
                                <rect x="124" y="34" width="37" height="31" rx="5" fill="#DC2626"
                                    filter="url(#hm-shadow)" />
                                <rect x="165" y="34" width="37" height="31" rx="5" fill="#B91C1C"
                                    filter="url(#hm-shadow)" />
                                <!-- Row 3 = Medium likelihood -->
                                <rect x="1" y="67" width="37" height="31" rx="5" fill="#D1FAE5"
                                    filter="url(#hm-shadow)" />
                                <rect x="42" y="67" width="37" height="31" rx="5" fill="#FEF9C3"
                                    filter="url(#hm-shadow)" />
                                <rect x="83" y="67" width="37" height="31" rx="5" fill="#FDE68A"
                                    filter="url(#hm-shadow)" />
                                <rect x="124" y="67" width="37" height="31" rx="5" fill="#FCA5A5"
                                    filter="url(#hm-shadow)" />
                                <rect x="165" y="67" width="37" height="31" rx="5" fill="#EF4444"
                                    filter="url(#hm-shadow)" />
                                <!-- Row 4 = Low likelihood -->
                                <rect x="1" y="100" width="37" height="31" rx="5" fill="#D1FAE5"
                                    filter="url(#hm-shadow)" />
                                <rect x="42" y="100" width="37" height="31" rx="5" fill="#D1FAE5"
                                    filter="url(#hm-shadow)" />
                                <rect x="83" y="100" width="37" height="31" rx="5" fill="#FEF9C3"
                                    filter="url(#hm-shadow)" />
                                <rect x="124" y="100" width="37" height="31" rx="5" fill="#FDE68A"
                                    filter="url(#hm-shadow)" />
                                <rect x="165" y="100" width="37" height="31" rx="5" fill="#FCA5A5"
                                    filter="url(#hm-shadow)" />
                                <!-- Row 5 bottom = Very Low likelihood -->
                                <rect x="1" y="133" width="37" height="31" rx="5" fill="#D1FAE5"
                                    filter="url(#hm-shadow)" />
                                <rect x="42" y="133" width="37" height="31" rx="5" fill="#D1FAE5"
                                    filter="url(#hm-shadow)" />
                                <rect x="83" y="133" width="37" height="31" rx="5" fill="#D1FAE5"
                                    filter="url(#hm-shadow)" />
                                <rect x="124" y="133" width="37" height="31" rx="5" fill="#FEF9C3"
                                    filter="url(#hm-shadow)" />
                                <rect x="165" y="133" width="37" height="31" rx="5" fill="#D1FAE5"
                                    filter="url(#hm-shadow)" />
                                <!-- Risk count labels -->
                                <text x="19.5" y="21" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#DC2626">0</text>
                                <text x="60.5" y="21" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#fff">1</text>
                                <text x="101.5" y="21" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#fff">2</text>
                                <text x="142.5" y="21" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#fff">4</text>
                                <text x="183.5" y="21" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#fff">4</text>
                                <text x="19.5" y="54" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#374151">1</text>
                                <text x="60.5" y="54" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#DC2626">3</text>
                                <text x="101.5" y="54" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#fff">5</text>
                                <text x="142.5" y="54" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#fff">3</text>
                                <text x="183.5" y="54" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#fff">1</text>
                                <text x="19.5" y="87" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#374151">3</text>
                                <text x="60.5" y="87" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#374151">8</text>
                                <text x="101.5" y="87" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#374151">4</text>
                                <text x="142.5" y="87" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#DC2626">2</text>
                                <text x="183.5" y="87" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#fff">0</text>
                                <text x="19.5" y="120" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#374151">5</text>
                                <text x="60.5" y="120" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#374151">3</text>
                                <text x="101.5" y="120" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#374151">2</text>
                                <text x="142.5" y="120" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#374151">1</text>
                                <text x="183.5" y="120" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#DC2626">0</text>
                                <text x="19.5" y="153" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#374151">2</text>
                                <text x="60.5" y="153" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#374151">1</text>
                                <text x="101.5" y="153" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#374151">0</text>
                                <text x="142.5" y="153" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#374151">0</text>
                                <text x="183.5" y="153" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="11" font-weight="700" fill="#374151">0</text>
                            </svg>
                        </div>
                    </div>
                    <!-- Legend -->
                    <div
                        style="display:flex;align-items:center;gap:8px;justify-content:center;margin-top:10px;flex-wrap:wrap;">
                        <div class="hm-legend-item">
                            <div class="hm-swatch" style="background:#D1FAE5;"></div>Low
                        </div>
                        <div class="hm-legend-item">
                            <div class="hm-swatch" style="background:#FEF9C3;"></div>Medium
                        </div>
                        <div class="hm-legend-item">
                            <div class="hm-swatch" style="background:#FDE68A;"></div>High
                        </div>
                        <div class="hm-legend-item">
                            <div class="hm-swatch" style="background:#EF4444;"></div>V.High
                        </div>
                        <div class="hm-legend-item">
                            <div class="hm-swatch" style="background:#7F1D1D;"></div>Critical
                        </div>
                    </div>
                    <div style="margin-top:7px;text-align:center;">
                        <span
                            style="font-family:'JetBrains Mono',monospace;font-size:8px;color:#94A3B8;letter-spacing:0.04em;">Y
                            = Likelihood · X = Impact · numbers = risk count</span>
                    </div>
                </div>
                    ...
                    <div class="rings-grid">
                        ...
                        <div class="ring-row">
                            <svg viewBox="0 0 60 60" width="52" height="52" style="flex-shrink:0;"
                                role="img" aria-label="SAMA-CSF 91%">
                                <defs>
                                ...
                                <circle cx="30" cy="30" r="24" fill="none" stroke="#DBEAFE"
                                    stroke-width="6" />
                                <circle cx="30" cy="30" r="24" fill="none" stroke="url(#rg1)"
                                    stroke-width="6" stroke-linecap="round" class="ring-arc ring-91"
                                    transform="rotate(-90 30 30)" />
                                <text x="30" y="28" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="9" font-weight="700" fill="#1D4ED8">91%</text>
                            </svg>
                            <div class="ring-info">
                                <div class="ring-framework">SAMA-CSF</div>
                                <div class="ring-sub" style="color:#2563EB;">91% compliant</div>
                                <div class="ring-bar">
                                    <div class="ring-bar-fill"
                                        style="width:91%;background:linear-gradient(90deg,#2563EB,#60A5FA);"></div>
                                </div>
                            </div>
                        </div>
                        <!-- NCA ECC 78% violet -->
                        <div class="ring-row">
                            <svg viewBox="0 0 60 60" width="52" height="52" style="flex-shrink:0;"
                                role="img" aria-label="NCA ECC 78%">
                                <defs>
                                ...
                                <circle cx="30" cy="30" r="24" fill="none" stroke="#EDE9FE"
                                    stroke-width="6" />
                                <circle cx="30" cy="30" r="24" fill="none" stroke="url(#rg2)"
                                    stroke-width="6" stroke-linecap="round" class="ring-arc ring-78"
                                    transform="rotate(-90 30 30)" />
                                <text x="30" y="28" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="9" font-weight="700" fill="#5B21B6">78%</text>
                            </svg>
                            <div class="ring-info">
                                ...
                                <div class="ring-bar">
                                    <div class="ring-bar-fill"
                                        style="width:78%;background:linear-gradient(90deg,#7C3AED,#A78BFA);"></div>
                                </div>
                            </div>
                        </div>
                        <!-- PDPL 85% emerald -->
                        <div class="ring-row">
                            <svg viewBox="0 0 60 60" width="52" height="52" style="flex-shrink:0;"
                                role="img" aria-label="PDPL 85%">
                                <defs>
                                    <linearGradient id="rg3" x1="0%" y1="0%" x2="100%"
                                        y2="100%">
                                        <stop offset="0%" stop-color="#059669" />
                                        <stop offset="100%" stop-color="#34D399" />
                                    </linearGradient>
                                </defs>
                                <circle cx="30" cy="30" r="24" fill="none" stroke="#D1FAE5"
                                    stroke-width="6" />
                                <circle cx="30" cy="30" r="24" fill="none" stroke="url(#rg3)"
                                    stroke-width="6" stroke-linecap="round" class="ring-arc ring-85"
                                    transform="rotate(-90 30 30)" />
                                <text x="30" y="28" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="9" font-weight="700" fill="#065F46">85%</text>
                            </svg>
                            <div class="ring-info">
                                ...
                                <div class="ring-bar">
                                    <div class="ring-bar-fill"
                                        style="width:85%;background:linear-gradient(90deg,#059669,#34D399);"></div>
                                </div>
                            </div>
                        </div>
                        <!-- OSMACC 72% amber -->
                        <div class="ring-row">
                            <svg viewBox="0 0 60 60" width="52" height="52" style="flex-shrink:0;"
                                role="img" aria-label="OSMACC 72%">
                                <defs>
                                    <linearGradient id="rg4" x1="0%" y1="0%" x2="100%"
                                        y2="100%">
                                        <stop offset="0%" stop-color="#D97706" />
                                        <stop offset="100%" stop-color="#FCD34D" />
                                    </linearGradient>
                                </defs>
                                <circle cx="30" cy="30" r="24" fill="none" stroke="#FEF3C7"
                                    stroke-width="6" />
                                <circle cx="30" cy="30" r="24" fill="none" stroke="url(#rg4)"
                                    stroke-width="6" stroke-linecap="round" class="ring-arc ring-72"
                                    transform="rotate(-90 30 30)" />
                                <text x="30" y="28" text-anchor="middle" font-family="JetBrains Mono,monospace"
                                    font-size="9" font-weight="700" fill="#78350F">72%</text>
                            </svg>
                            <div class="ring-info">
                                ...
                                <div class="ring-bar">
                                    <div class="ring-bar-fill"
                                        style="width:72%;background:linear-gradient(90deg,#D97706,#FCD34D);"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="ig-panel reveal reveal-delay-2">
                    <div class="ig-panel-header">
                        ...
                        <span
                            style="font-family:'JetBrains Mono',monospace;font-size:10px;color:#94A3B8;font-weight:600;">124
                            total</span>
                    </div>
                    ...
                    <div
                        style="font-family:'JetBrains Mono',monospace;font-size:10px;color:#94A3B8;text-align:center;margin-bottom:14px;">
                        71.8% pass rate &mdash; industry avg: 65%</div>
                    <div class="ctrl-eff-detail">
                        <div class="ctrl-eff-row">
                            <span class="ctrl-eff-row-label">Critical Risks</span>
                            <span class="ctrl-eff-pill"
                                style="color:#DC2626;background:#FEE2E2;border:1px solid rgba(220,38,38,0.2);">8</span>
                        </div>
                        <div class="ctrl-eff-row">
                            <span class="ctrl-eff-row-label">High Risks</span>
                            <span class="ctrl-eff-pill"
                                style="color:#D97706;background:#FEF3C7;border:1px solid rgba(217,119,6,0.2);">23</span>
                        </div>
                        <div class="ctrl-eff-row">
                            <span class="ctrl-eff-row-label">Audit Findings</span>
                            <span class="ctrl-eff-pill"
                                style="color:#2563EB;background:#EFF6FF;border:1px solid rgba(37,99,235,0.2);">7</span>
                        </div>
                        <div class="ctrl-eff-row">
                            <span class="ctrl-eff-row-label">Assets Tracked</span>
                            <span class="ctrl-eff-pill"
                                style="color:#059669;background:#D1FAE5;border:1px solid rgba(5,150,105,0.2);">342</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="features-grid" id="modules">
                ...
                <div class="feature-card fc-amber reveal">
                    ...
                    <p class="feature-desc">Catalogue and classify information assets, link them to risks and
                        controls, and track ownership across your entire organizational inventory.</p>
                    <!-- Mini asset network SVG decorative -->
                    <svg viewBox="0 0 180 60" width="180" style="margin-top:20px;opacity:0.55;"
                        aria-hidden="true">
                        <circle cx="20" cy="30" r="8" fill="none" stroke="#D97706"
                            stroke-width="1.5" />
                        <circle cx="20" cy="30" r="3" fill="#D97706" />
                        <circle cx="60" cy="14" r="6" fill="none" stroke="#D97706"
                            stroke-width="1.5" opacity="0.7" />
                        <circle cx="60" cy="14" r="2.5" fill="#D97706" opacity="0.7" />
                        <circle cx="60" cy="46" r="6" fill="none" stroke="#F59E0B"
                            stroke-width="1.5" opacity="0.6" />
                        <circle cx="60" cy="46" r="2.5" fill="#F59E0B" opacity="0.6" />
                        <circle cx="100" cy="8" r="5" fill="none" stroke="#D97706"
                            stroke-width="1.5" opacity="0.5" />
                        <circle cx="100" cy="30" r="5" fill="none" stroke="#F59E0B"
                            stroke-width="1.5" opacity="0.5" />
                        <circle cx="100" cy="52" r="5" fill="none" stroke="#D97706"
                            stroke-width="1.5" opacity="0.4" />
                        <circle cx="140" cy="20" r="4" fill="none" stroke="#D97706"
                            stroke-width="1.5" opacity="0.4" />
                        <circle cx="140" cy="40" r="4" fill="none" stroke="#F59E0B"
                            stroke-width="1.5" opacity="0.35" />
                        <line x1="28" y1="26" x2="54" y2="16" stroke="#D97706"
                            stroke-width="1" stroke-dasharray="3 2" opacity="0.5" />
                        <line x1="28" y1="34" x2="54" y2="44" stroke="#F59E0B"
                            stroke-width="1" stroke-dasharray="3 2" opacity="0.5" />
                        <line x1="66" y1="14" x2="95" y2="10" stroke="#D97706"
                            stroke-width="1" stroke-dasharray="3 2" opacity="0.4" />
                        <line x1="66" y1="18" x2="95" y2="28" stroke="#D97706"
                            stroke-width="1" stroke-dasharray="3 2" opacity="0.4" />
                        <line x1="66" y1="44" x2="95" y2="52" stroke="#F59E0B"
                            stroke-width="1" stroke-dasharray="3 2" opacity="0.4" />
                        <line x1="105" y1="28" x2="136" y2="22" stroke="#D97706"
                            stroke-width="1" stroke-dasharray="3 2" opacity="0.35" />
                        <line x1="105" y1="32" x2="136" y2="38" stroke="#F59E0B"
                            stroke-width="1" stroke-dasharray="3 2" opacity="0.35" />
                        <text x="175" y="32" text-anchor="end" font-family="JetBrains Mono,monospace"
                            font-size="8" fill="#D97706" opacity="0.6" font-weight="700">342 assets</text>
                    </svg>
                </div>
                ...
                <div class="feature-card fc-rose reveal reveal-delay-1">
                    ...
                    <!-- Risk matrix heatmap -->
                    <svg viewBox="0 0 156 58" width="156" style="margin-top:18px;opacity:0.72;"
                        aria-hidden="true">
                        <!-- Row: High likelihood -->
                        ...
                        <!-- Cell text -->
                        <text x="25" y="13.5" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" font-weight="700" fill="#D97706">MED</text>
                        <text x="75" y="13.5" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" font-weight="700" fill="#DC2626">HIGH</text>
                        <text x="128" y="13.5" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" font-weight="700" fill="#fff">CRIT</text>
                        <text x="25" y="32.5" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" font-weight="700" fill="#059669">LOW</text>
                        <text x="75" y="32.5" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" font-weight="700" fill="#D97706">MED</text>
                        <text x="128" y="32.5" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" font-weight="700" fill="#DC2626">HIGH</text>
                        <text x="25" y="51.5" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" font-weight="700" fill="#059669">LOW</text>
                        <text x="75" y="51.5" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" font-weight="700" fill="#059669">LOW</text>
                        <text x="128" y="51.5" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" font-weight="700" fill="#D97706">MED</text>
                        <!-- Risk count chip on critical cell -->
                        <circle cx="145" cy="6" r="5" fill="rgba(255,255,255,0.28)" />
                        <text x="145" y="9" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6.5" fill="#fff" font-weight="700">3</text>
                    </svg>
                </div>
                ...
                <div class="feature-card fc-violet reveal reveal-delay-2">
                    ...
                    <svg viewBox="0 0 180 82" width="180" style="margin-top:18px;opacity:0.72;"
                        aria-hidden="true">
                        <!-- Technical 84% -->
                        <text x="0" y="9" font-family="DM Sans,sans-serif" font-size="7.5" font-weight="600"
                            fill="#7C3AED">Technical</text>
                        <text x="180" y="9" text-anchor="end" font-family="JetBrains Mono,monospace"
                            font-size="7.5" font-weight="700" fill="#7C3AED">84%</text>
                        <rect x="0" y="12" width="180" height="5" rx="2.5" fill="#EDE9FE" />
                        <rect x="0" y="12" width="151" height="5" rx="2.5" fill="url(#vg1)" />
                        <!-- Administrative 71% -->
                        <text x="0" y="30" font-family="DM Sans,sans-serif" font-size="7.5" font-weight="600"
                            fill="#7C3AED">Administrative</text>
                        <text x="180" y="30" text-anchor="end" font-family="JetBrains Mono,monospace"
                            font-size="7.5" font-weight="700" fill="#7C3AED">71%</text>
                        <rect x="0" y="33" width="180" height="5" rx="2.5" fill="#EDE9FE" />
                        <rect x="0" y="33" width="128" height="5" rx="2.5" fill="url(#vg1)" />
                        <!-- Physical 93% -->
                        <text x="0" y="51" font-family="DM Sans,sans-serif" font-size="7.5" font-weight="600"
                            fill="#7C3AED">Physical</text>
                        <text x="180" y="51" text-anchor="end" font-family="JetBrains Mono,monospace"
                            font-size="7.5" font-weight="700" fill="#7C3AED">93%</text>
                        <rect x="0" y="54" width="180" height="5" rx="2.5" fill="#EDE9FE" />
                        <rect x="0" y="54" width="167" height="5" rx="2.5" fill="url(#vg1)" />
                        <!-- Operational 76% -->
                        <text x="0" y="72" font-family="DM Sans,sans-serif" font-size="7.5" font-weight="600"
                            fill="#7C3AED">Operational</text>
                        <text x="180" y="72" text-anchor="end" font-family="JetBrains Mono,monospace"
                            font-size="7.5" font-weight="700" fill="#7C3AED">76%</text>
                        <rect x="0" y="75" width="180" height="5" rx="2.5" fill="#EDE9FE" />
                        <rect x="0" y="75" width="137" height="5" rx="2.5" fill="url(#vg1)" />
                        <defs>
                            <linearGradient id="vg1" x1="0%" y1="0%" x2="100%"
                                y2="0%">
                                <stop offset="0%" stop-color="#7C3AED" />
                                <stop offset="100%" stop-color="#A78BFA" />
                            </linearGradient>
                ...
                <div class="feature-card fc-blue reveal">
                    ...
                    <p class="feature-desc">Monitor compliance posture against SAMA-CSF, NCA ECC, BCMS, PDPL, and NIST
                        in real time.</p>
                    <!-- Framework compliance score bars -->
                    <svg viewBox="0 0 180 82" width="180" style="margin-top:18px;opacity:0.72;"
                        aria-hidden="true">
                        <defs>
                            <linearGradient id="bg1" x1="0%" y1="0%" x2="100%"
                                y2="0%">
                                <stop offset="0%" stop-color="#2563EB" />
                        ...
                        <!-- SAMA-CSF 91% -->
                        <text x="0" y="9" font-family="JetBrains Mono,monospace" font-size="7.5" font-weight="700"
                            fill="#2563EB">SAMA-CSF</text>
                        <text x="180" y="9" text-anchor="end" font-family="JetBrains Mono,monospace"
                            font-size="7.5" font-weight="700" fill="#2563EB">91%</text>
                        <rect x="0" y="12" width="180" height="5" rx="2.5" fill="#DBEAFE" />
                        <rect x="0" y="12" width="164" height="5" rx="2.5" fill="url(#bg1)" />
                        <!-- NCA ECC 85% -->
                        <text x="0" y="30" font-family="JetBrains Mono,monospace" font-size="7.5"
                            font-weight="700" fill="#2563EB">NCA ECC</text>
                        <text x="180" y="30" text-anchor="end" font-family="JetBrains Mono,monospace"
                            font-size="7.5" font-weight="700" fill="#2563EB">85%</text>
                        <rect x="0" y="33" width="180" height="5" rx="2.5" fill="#DBEAFE" />
                        <rect x="0" y="33" width="153" height="5" rx="2.5" fill="url(#bg1)" />
                        <!-- ITSM 78% -->
                        <text x="0" y="51" font-family="JetBrains Mono,monospace" font-size="7.5"
                            font-weight="700" fill="#2563EB">ITSM</text>
                        <text x="180" y="51" text-anchor="end" font-family="JetBrains Mono,monospace"
                            font-size="7.5" font-weight="700" fill="#2563EB">78%</text>
                        <rect x="0" y="54" width="180" height="5" rx="2.5" fill="#DBEAFE" />
                        <rect x="0" y="54" width="140" height="5" rx="2.5" fill="url(#bg1)" />
                        <!-- PDPL 82% -->
                        <text x="0" y="72" font-family="JetBrains Mono,monospace" font-size="7.5"
                            font-weight="700" fill="#2563EB">PDPL</text>
                        <text x="180" y="72" text-anchor="end" font-family="JetBrains Mono,monospace"
                            font-size="7.5" font-weight="700" fill="#2563EB">82%</text>
                ...
                <div class="feature-card fc-teal reveal reveal-delay-1">
                    ...
                    <svg viewBox="0 0 180 60" width="180" style="margin-top:18px;opacity:0.72;"
                        aria-hidden="true">
                        <defs>
                            <linearGradient id="tg1" x1="0%" y1="0%" x2="100%"
                                y2="0%">
                                <stop offset="0%" stop-color="#0EA5E9" />
                                <stop offset="100%" stop-color="#34D399" />
                            </linearGradient>
                            <linearGradient id="tg1-fill" x1="0%" y1="0%" x2="0%"
                                y2="100%">
                        ...
                        <!-- Trend line -->
                        <polyline points="0,44 36,36 72,28 108,20 144,12 180,6" fill="none" stroke="url(#tg1)"
                        ...
                        <!-- Month labels -->
                        <text x="0" y="58" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" fill="#94A3B8" font-weight="600">JAN</text>
                        <text x="36" y="58" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" fill="#94A3B8" font-weight="600">FEB</text>
                        <text x="72" y="58" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" fill="#94A3B8" font-weight="600">MAR</text>
                        <text x="108" y="58" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" fill="#94A3B8" font-weight="600">APR</text>
                        <text x="144" y="58" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" fill="#94A3B8" font-weight="600">MAY</text>
                        <text x="180" y="58" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6" fill="#94A3B8" font-weight="600">JUN</text>
                        <!-- Score label on last point -->
                        <rect x="154" y="0" width="24" height="10" rx="2" fill="#D1FAE5" />
                        <text x="166" y="8" text-anchor="middle" font-family="JetBrains Mono,monospace"
                            font-size="6.5" fill="#059669" font-weight="700">89%</text>
                    </svg>
                </div>
                ...
                <div class="feature-card fc-emerald reveal reveal-delay-2">
                    ...
                    <!-- Mini audit timeline -->
                    <svg viewBox="0 0 200 48" width="100%" style="margin-top:20px;max-width:200px;opacity:0.7;"
                        aria-hidden="true">
                        <defs>
                            <linearGradient id="auditLine2" x1="0%" y1="0%" x2="100%"
                                y2="0%">
                                <stop offset="0%" stop-color="#059669" />
                                <stop offset="100%" stop-color="#34D399" />
                            </linearGradient>
                        </defs>
                        <line x1="16" y1="20" x2="184" y2="20" stroke="#D1FAE5"
                            stroke-width="2" />
                        <line x1="16" y1="20" x2="140" y2="20"
                            stroke="url(#auditLine2)" stroke-width="2" />
                        ...
                        <circle cx="184" cy="20" r="6" fill="#D1FAE5" stroke="#A7F3D0"
                            stroke-width="1.5" />
                        <path d="M12 20l3 3 5-5" stroke="#fff" stroke-width="1.5" fill="none"
                            stroke-linecap="round" />
                        <path d="M56 20l3 3 5-5" stroke="#fff" stroke-width="1.5" fill="none"
                            stroke-linecap="round" />
                        <path d="M100 20l3 3 5-5" stroke="#fff" stroke-width="1.5" fill="none"
                            stroke-linecap="round" />
                        <circle cx="140" cy="20" r="3" fill="#fff" />
                        <text x="16" y="38" text-anchor="middle" font-family="DM Sans,sans-serif" font-size="7"
                            fill="#059669" font-weight="700">Plan</text>
                        <text x="60" y="38" text-anchor="middle" font-family="DM Sans,sans-serif" font-size="7"
                            fill="#059669" font-weight="700">Fieldwork</text>
                        <text x="104" y="38" text-anchor="middle" font-family="DM Sans,sans-serif" font-size="7"
                            fill="#059669" font-weight="700">Findings</text>
                        <text x="140" y="38" text-anchor="middle" font-family="DM Sans,sans-serif" font-size="7"
                            fill="#D97706" font-weight="700">Review</text>
                        <text x="184" y="38" text-anchor="middle" font-family="DM Sans,sans-serif" font-size="7"
                            fill="#94A3B8" font-weight="700">Closed</text>
                    </svg>
                </div>
                ...
                <div class="why-items">
                    <div class="why-item reveal">
                        ...
                        <div>
                            ...
                            <div class="why-item-desc">Competitors may focus on look and feel, but we focus on
                                content.
                    ...
                    <div class="why-item reveal reveal-delay-1">
                        ...
                        <div>
                            ...
                            <div class="why-item-desc">Full RTL support and Arabic-language reports for local teams
                                and
                                regulators.</div>
                        </div>
                    </div>

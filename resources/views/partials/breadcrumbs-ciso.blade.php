    ...
    <div class="mb-6 flex flex-wrap items-end justify-between gap-3">
        ...
        <nav>
            <ol class="flex items-center gap-1.5">
                ...
                @if(request()->route()->getName() == 'process.view.show' || request()->route()->getName() == 'process.resource.checklist' || request()->route()->getName() == 'process.resource.videos' || request()->route()->getName() == 'process.resource.glossary' || request()->route()->getName() == 'process.resource.template')
                <li>
                    <a class="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400"

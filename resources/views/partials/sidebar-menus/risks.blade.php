<x-sidebar-menu-item route_name="risks.index" label_ar="تحديد المخاطر" label="Risk Identification" />
...
<x-sidebar-menu-item route_name="risk-treatment-options.index" label_ar="خيارات علاج المخاطر" label="Risk Treatment" />

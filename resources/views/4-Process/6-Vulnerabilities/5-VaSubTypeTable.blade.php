                ...
                <div class="ContentTableSection">
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p class="sh-tx">{{ $vulnerabilitySubType?->va_sub_type_id }}</p>
                        </div>
                        <div class="column">
                            <div class="FieldHead">
                            ...
                            <p class="sh-tx">{{ $vulnerabilitySubType?->va_sub_type_name }}</p>
                        </div>
                    </div>
                    <div class="ContentTablebg">
                        <div class="column">
                            ...
                            <p class="bg-tx">{{ $vulnerabilitySubType?->va_sub_type_description }}</p>
                        </div>
                    </div>
                    <div class="ContentTablebg">
                        <div class="column">
                            ...
                            <p class="bg-tx">{{ $vulnerabilitySubType?->va_sub_type_remarks }}</p>
                        </div>
                    </div>
                    <div class="ContentTablebg">
                        <div class="column">
                            ...
                            <p class="bg-tx">{{ $vulnerabilitySubType->type?->va_type_name }}</p>
                        </div>
                    </div>
                </div>
            </table>

...
<body>
    ...
    <!-- CONTENT -->
    <div class="IndiTable">
        <form method="POST" action="{{ route('delete.cvss') }}">
            @csrf
            @method('DELETE')
            <div class="TableHeading">
                ...
                <div class="ButtonContainer">
                    ...
                    <a href="/cvss-input" class="MoreButton">
                ...
                <table cellspacing="0">
                    <tr>
                        ...
                        <th style="padding-right: 0px;">
                            <p class="ListHeadArbTxt">CVSS رمز</p>
                            <p class="ListHeadEngTxt">CVSS ID</p>
                        </th>
                        <th style="padding-right: 100px;">
                            <p class="ListHeadArbTxt">CVSS اسم</p>
                            <p class="ListHeadEngTxt">CVSS Name</p>
                        </th>
                        <th style="padding-right: 0px;">
                            <p class="ListHeadArbTxt">CVSS رقم</p>
                            <p class="ListHeadEngTxt">CVSS Number</p>
                        </th>
                    </tr>
                    @foreach ($columns as $data)
                        <tr>
                            <td><input type="checkbox" name="selecteddelete[]" value="{{ $data->cvss_id }}">
                            </td>
                            <td><a href="/cvss-table/{{ $data->cvss_id }}">{{ $data->cvss_id }}</a>
                            </td>
                            <td>{{ $data->cvss_name }}</td>
                            <td>{{ $data->cvss_number }}</td>
                        </tr>
                    @endforeach
                </table>
            </div>

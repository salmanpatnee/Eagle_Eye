    ...
    <div class="IndiTable">
        <div class="TableHeading">
            ...
            <div class="ButtonContainer">
                ...
                <a href="{{ route('cvss.edit', $cvss_id->cvss_id) }}" class="MoreButton">
            ...
            <div class="ContentTableSection">
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $cvss_id->cvss_id }}</p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <p class="sh-tx">{{ $cvss_id->cvss_name }}</p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $cvss_id->cvss_number }}</p>
                    </div>
                </div>
                <div class="ContentTablebg">
                    <div class="column">
                        ...
                        <p class="bg-tx">{{ $cvss_id->cvss_description }}</p>
                    </div>
                </div>
                <div class="ContentTablebg">
                    <div class="column">
                        ...
                        <p class="bg-tx">{{ $cvss_id->cvss_remarks }}</p>
                    </div>
                </div>
            </div>
        </table>

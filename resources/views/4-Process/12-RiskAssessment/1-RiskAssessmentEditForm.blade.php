...
<body>
    ...
    <form action="{{ route('risk-assessment-findings.update', $riskAssessmentDetail->id) }}" method="POST">
        @if ($errors->any())
            ...
            <div class="ContentTableSection">
                ...
                <div class="ContentTable">
                    <div class="column">
                        <x-input label="Risk Assessment Finding ID" label_ar="رمز العثور على" name="risk_finding_id"
                            placeholder="Enter ID" readonly :value="$riskAssessmentDetail->risk_finding_id" />
                    </div>
                    <div class="column">
                        <x-input label="Risk Assessment Finding Name" label_ar="اسم العثور على" name="risk_finding_name"
                            placeholder="Enter Name" :value="$riskAssessmentDetail->risk_finding_name" required />
                    </div>
                </div>
                <div class="ContentTable">
                    ...
                    <div class="column">
                        <x-input label="Risk Assessment Finding Description" label_ar="وصف العثور على"
                            ...
                            :value="$riskAssessmentDetail->risk_finding_description" />
                ...
                <div class="ContentTable">
                            ...
                            <select name="risk_id" id="risk_dropdown" class="sh-tx" style="width: 480px;" required>
                                ...
                                @foreach ($risks as $risk)
                                    <option value="{{ $risk->risk_id }}"
                                        {{ old('risk_id', $riskAssessmentDetail->risk_id) == $risk->risk_id ? 'selected' : null }}>
                    ...
                    <div class="column">
                        ...
                        <select name="implementation_status" id="implementation_status" class="sh-tx" required>
                            <option value="Open"
                                {{ old('implementation_status', $riskAssessmentDetail->implementation_status) == 'Open' ? 'selected' : null }}>
                                Open</option>
                            <option value="Close"
                                {{ old('implementation_status', $riskAssessmentDetail->implementation_status) == 'Close' ? 'selected' : null }}>
                                Close</option>
                        </select>
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <select name="risk_likelihood" id="riskLikelihood" class="sh-tx" required>
                            <option value="1"
                                {{ old('risk_likelihood', $riskAssessmentDetail->risk_likelihood) == '1' ? 'selected' : null }}>
                                1</option>
                            <option value="2"
                                {{ old('risk_likelihood', $riskAssessmentDetail->risk_likelihood) == '2' ? 'selected' : null }}>
                                2</option>
                            <option value="3"
                                {{ old('risk_likelihood', $riskAssessmentDetail->risk_likelihood) == '3' ? 'selected' : null }}>
                                3</option>
                            <option value="4"
                                {{ old('risk_likelihood', $riskAssessmentDetail->risk_likelihood) == '4' ? 'selected' : null }}>
                                4</option>
                            <option value="5"
                                {{ old('risk_likelihood', $riskAssessmentDetail->risk_likelihood) == '5' ? 'selected' : null }}>
                                5</option>
                        </select>
                    ...
                    <div class="column">
                        ...
                        <select name="risk_impact" id="riskImpact" class="sh-tx" required>
                            <option value="1"
                                {{ old('risk_impact', $riskAssessmentDetail->risk_impact) == '1' ? 'selected' : null }}>
                                1</option>
                            <option value="2"
                                {{ old('risk_impact', $riskAssessmentDetail->risk_impact) == '2' ? 'selected' : null }}>
                                2</option>
                            <option value="3"
                                {{ old('risk_impact', $riskAssessmentDetail->risk_impact) == '3' ? 'selected' : null }}>
                                3</option>
                            <option value="4"
                                {{ old('risk_impact', $riskAssessmentDetail->risk_impact) == '4' ? 'selected' : null }}>
                                4</option>
                            <option value="5"
                                {{ old('risk_impact', $riskAssessmentDetail->risk_impact) == '5' ? 'selected' : null }}>
                                5</option>
                        </select>
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="risk_score" id="riskScore" class="sh-tx"
                                value="{{ $riskAssessmentDetail->risk_score }}" required></p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <p><input type="text" name="appetiteColor" id="appetiteColor" class="sh-tx"
                                value="{{ old('risk_appetite', $riskAssessmentDetail->risk_appetite) }}"
                                style="background-color: {{ $riskAssessmentDetail->risk_appetite_color }}"
                                readonly="">
                            <input type="hidden" name="risk_appetite" id="appetite" class="sh-tx" value="{{ old('risk_appetite', $riskAssessmentDetail->risk_appetite) }}">
                            <input type="hidden" name="risk_appetite_color" id="riskAppetiteColor" class="sh-tx" value="{{ old('risk_appetite_color', $riskAssessmentDetail->risk_appetite_color) }}">
                        </p>
                    </div>
                </div>
                ...
                <div class="ContentTable">
                    <div class="column">
                        <x-input label="Risk Implementation Details" label_ar="ضوابط تفاصيل التنفيذ"
                            name="implementation_details" class="bg-tx" :value="$riskAssessmentDetail->implementation_details" />
                    </div>
                </div>
                ...
                <div class="ContentTable">
                    <div class="column">
                        <x-input label="Risk Maturity Justification" label_ar="ضوابط تفاصيل التنفيذ"
                            name="maturity_justification" class="bg-tx" :value="$riskAssessmentDetail->maturity_justification" />
                    </div>
                </div>
                ...
                <div class="ContentTable">
                    <div class="column">
                        <x-input label="Risk Assessment Remarks" label_ar="ملاحظات تقييم المخاطر" name="Remarks"
                            class="bg-tx" :value="$riskAssessmentDetail->Remarks" />
                    </div>
                </div>

                <div class="ContentTable">
                    <div class="column">
                        <x-input label="Auditee Name" label_ar="" name="risk_auditee_name" :value="$riskAssessmentDetail->risk_auditee_name" />
                    </div>
                    <div class="column">
                        <x-input label="Auditee Department" label_ar="" name="risk_auditee_department"
                            :value="$riskAssessmentDetail->risk_auditee_department" />
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        <x-input label="Auditee System" label_ar="تم تدقيق النظام" name="risk_auditee_system"
                            :value="$riskAssessmentDetail->risk_auditee_system" />
                    </div>
                    <div class="column">
                        ...
                        <select name="risk_treatment_id" id="risk_treatment_id" class="sh-tx" required>
                            ...
                            @foreach ($treatments as $treatment)
                                <option value="{{ $treatment->risk_treatment_id }}"
                                    {{ old('risk_treatment_id', $riskAssessmentDetail->risk_treatment_id) == $treatment->risk_treatment_id ? 'selected' : null }}>
                ...
                <div class="ContentTable">
                    <div class="column">
                        <x-input label="Corrective Action" label_ar="" name="corrective_action"
                            :value="$riskAssessmentDetail->corrective_action" />

                    </div>
                    <div class="column">
                        <x-input label="Corrective Action Due Date" label_ar="" name="corrective_action_due_date"
                            :value="$riskAssessmentDetail->corrective_action_due_date" type="date" />
                    </div>
                </div>
                ...
                <div class="ContentTable">
                    <div class="column">
                        <x-input label="Preventive Ation" label_ar="" name="preventive_action"
                            :value="$riskAssessmentDetail->preventive_action" />
                    </div>
                    <div class="column">
                        <x-input label="Preventive Ation due date" label_ar="" name="preventive_action_due_date"
                            :value="$riskAssessmentDetail->preventive_action_due_date" type="date" />
                    </div>
                </div>
                ...
                <div class="ContentTable">
                    <div class="column">
                        <x-input label="Lesson Learned" label_ar="تم تدقيق النظام" name="lesson_learned"
                            :value="$riskAssessmentDetail->lesson_learned" class="bg-tx" />

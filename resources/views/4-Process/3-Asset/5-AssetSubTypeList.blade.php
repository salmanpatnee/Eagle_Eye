...
<body>
                    ...
                    <table cellspacing="0">
                        <tr class="table-header">
                            ...
                            <th style="padding-right: 0px;">
                                ...
                                <p class="ListHeadEngTxt">Asset Sub-Type ID</p>
                            </th>
                            <th style="padding-right: 100px;">
                                <p class="ListHeadArbTxt">اسم النوع الفرعي للأصول</p>
                                <p class="ListHeadEngTxt">Asset Sub-Type Name</p>
                            </th>
                            <th style="padding-right: 100px;">
                            ...
                            <th style="padding-right: 100px;">
                                <p class="ListHeadArbTxt">وصف النوع الفرعي للأصول</p>
                        ...
                        @foreach ($assetSubTypes as $assetSubType)
                            <tr>
                                ...
                                <td>{{ $loop->index + 1 }}</td>
                                <td><a
                                        href="/asset-sub-type-table/{{ $assetSubType->asset_sub_type_id }}">{{ $assetSubType->asset_sub_type_id }}</a>
                                </td>
                                <td>{{ $assetSubType->asset_sub_type_name }}</td>
                                <td>{{ $assetSubType->asset_sub_type_name }}</td>
                                <td>{{ $assetSubType->asset_sub_type_name }}</td>
                            </tr>
                        @endforeach
    ...
    <script>
        document.getElementById('btnUpdate').addEventListener('click', function(event) {
            ...
            if (selectedRadio) {
                window.location.href = `/asset-sub-type/edit/${selectedRadio.value}`;
            } else {

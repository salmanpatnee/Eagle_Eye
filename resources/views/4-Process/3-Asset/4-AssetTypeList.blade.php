...
<body>
                        ...
                        <table cellspacing="0">
                            <tr class="table-header">
                                ...
                                <th style="padding-right: 0px;">
                                    ...
                                    <p class="ListHeadEngTxt">Asset Type ID</p>
                                </th>
                                <th style="padding-right: 100px;">
                                    <p class="ListHeadArbTxt">اسم نوع الأصل</p>
                                    <p class="ListHeadEngTxt">Asset Type Name</p>
                                </th>
                                <th style="padding-right: 100px;">
                                    <p class="ListHeadArbTxt">وصف نوع الأصل</p>
                                    <p class="ListHeadEngTxt">Asset Type Description</p>
                                </th>
                            </tr>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="record" class="record"
                                            value="{{ $AssetType->asset_type_id }}" required>
                                    </td>
                                    <td>{{ $loop->index + 1 }}</td>
                                    <td style="width: 150px;"><a
                                            href="/asset-type-table/{{ $AssetType->asset_type_id }}">{{ $AssetType->asset_type_id }}</a>
                                    </td>
                                    <td>{{ $AssetType->asset_type_name }}</td>
                                    <td>{{ $AssetType->asset_type_description }}</td>
                                </tr>
                            @endforeach
                        </table>
                    </div>
    ...
    <script>
        document.getElementById('btnUpdate').addEventListener('click', function(event) {
            ...
            if (selectedRadio) {
                window.location.href = `/asset-type/edit/${selectedRadio.value}`;
            } else {

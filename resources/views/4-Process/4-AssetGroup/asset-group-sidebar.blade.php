...
<section id="sidebar">
    <ul class="side-menu top">
        <li
            class="{{ request()->routeIs('asset-groups.index') || request()->routeIs('asset-groups.show') ? 'active' : '' }}">
            <a href="/asset-groups">
        ...
        @if (auth()->user()->can('manage-asset'))
            <li
                class="{{ request()->routeIs('asset-groups.create') || request()->routeIs('asset-groups.edit') ? 'active' : '' }}">
                <a href="/asset-groups/create">
                    <i class='bx bxs-label'></i>
                    <div class="MenuTxt">

...
<body>
                ...
                <div class="ListTable">
                    <table cellspacing="0">
                        <tr class="table-header">
                            ...
                            <th style="padding-right: 0px;">
                                <p class="ListHeadArbTxt">رمز المراجعة</p>
                                <p class="ListHeadEngTxt">Audit ID</p>
                            </th>
                            <th style="padding-right: 100px;">
                                <p class="ListHeadArbTxt">اسم المراجعة</p>
                                <p class="ListHeadEngTxt">Audit Name</p>
                            </th>
                            <th style="padding-right: 0px;">
                                <p class="ListHeadArbTxt">تاريخ بدء خطة التدقيق</p>
                                <p class="ListHeadEngTxt">Audit Start Date</p>
                            </th>
                            <th style="padding-right: 0px;">
                                <p class="ListHeadArbTxt">تاريخ انتهاء خطة التدقيق</p>
    ...
    <script ript src="/Css/4-Process/1-Form/1-Form.js"></script>
    ...
    <script>
        ...
        document.getElementById('btnUpdate').addEventListener('click', function(event) {
            ...
            if (selectedRadio) {
                window.location.href = `/audit-plan/edit/${selectedRadio.value}`;
            } else {

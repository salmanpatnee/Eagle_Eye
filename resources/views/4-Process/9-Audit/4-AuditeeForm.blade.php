...
<body>
    ...
    <!-- CONTENT -->
    <form action="/auditee-input/post" method="post">
        @csrf
        <div class="IndiTable">
                ...
                <div class="ContentTableSection">
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="auditee_id" id="auditee_id" class="sh-tx"
                                    placeholder="Enter Auditee ID" value="{{old('auditee_id')}}" required></p>
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="auditee_first_name" id="auditee_first_name" class="sh-tx"
                                    placeholder="Write Auditee First Name" value="{{old('auditee_first_name')}}" required></p>
                        ...
                        <div class="column">
                            ...
                            <p><input type="text" name="auditee_last_name" id="auditee_last_name" class="sh-tx"
                                    placeholder="Write Auditee Last Name" value="{{old('auditee_last_name')}}"></p>
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p>
                                <select name="auditee_department" id="auditee_department" class="sh-tx"
                                    required>
                                    <option value="" disabled selected hidden>Select Option</option>
                                    @foreach ($DepartNames as $DepartName)
                                        <option value="{{ $DepartName->department_id }}" {{old('auditee_department') == $DepartName->department_id ? 'selected' : null}}>

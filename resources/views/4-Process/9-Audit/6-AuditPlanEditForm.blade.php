        ...
        <div class="TableHeading">
            ...
            <div class="ButtonContainer">
                ...
                <form method="POST" action="{{ route($routeName . '.delete') }}" id="delete_form">
                    <input type="hidden" name="record" value="{{ $data?->audit_id }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
        </div>
        <form id="form" action="/audit-plan/{{ $auditData->audit_id }}" method="post">
            @csrf
            @method('PATCH')
            <table cellspacing="0">
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="audit_id" id="audit_id" class="sh-tx"
                                    value="{{ old('audit_id', $auditData->audit_id) }}" required readonly></p>
                        ...
                        <div class="column">
                            ...
                            <p><input type="text" name="audit_name" id="audit_name" class="sh-tx" required
                                    value="{{ old('audit_name', $auditData->audit_name) }}"></p>
                    ...
                    <div class="ContentTablebg">
                        <div class="column">
                            ...
                            <p><input type="text" name="audit_description" id="audit_description" class="bg-tx"
                                    ...
                                    value="{{ old('audit_description', $auditData->audit_description) }}"></p>
                    ...
                    <div class="ContentTablebg">
                        <div class="column">
                            ...
                            <p><input type="text" name="audit_sponsor" id="audit_sponsor" class="bg-tx"
                                    value="{{ old('audit_sponsor', $auditData->audit_sponsor) }}"></p>
                    ...
                    <div class="ContentTablebg">
                        <div class="column">
                            ...
                            <p><input type="text" name="audit_scope" id="audit_scope" class="bg-tx"
                                    value="{{ old('audit_scope', $auditData->audit_scope) }}"></p>
                    ...
                    <div class="ContentTablebg">
                        <div class="column">
                            ...
                            <p><input type="text" name="audit_objectives" id="audit_objectives" class="bg-tx"
                                    value="{{ old('audit_objectives', $auditData->audit_objectives) }}"></p>
                    ...
                    <div class="ContentTablebg">
                        <div class="column">
                            ...
                            <p><input type="text" name="audit_criteria" id="audit_criteria" class="bg-tx"
                                    value="{{ old('audit_criteria', $auditData->audit_criteria) }}"></p>
                    ...
                    <div class="ContentTablebg">
                        <div class="column">
                            ...
                            <p><input type="text" name="audit_methodology" id="audit_methodology" class="bg-tx"
                                    value="{{ old('audit_methodology', $auditData->audit_methodology) }}"></p>
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="date" name="audit_plan_start_date" id="audit_plan_start_date"
                                    ...
                                    value="{{ old('audit_plan_start_date', $auditData->audit_plan_start_date) }}"></p>
                        ...
                        <div class="column">
                            ...
                            <p><input type="date" name="audit_plan_end_date" id="audit_plan_end_date"
                                    class="sh-tx" required
                                    value="{{ old('audit_plan_end_date', $auditData->audit_plan_end_date) }}"></p>
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="auditing_entity" id="auditing_entity" class="sh-tx"
                                    value="{{ old('auditing_entity', $auditData->auditing_entity) }}"></p>
                                ...
                                <select name="auditee_id" id="auditee_id" class="sh-tx" required>
                                    ...
                                    @foreach ($AuditeeNames as $AuditeeName)
                                        <option value="{{ $AuditeeName->auditee_id }}"
                                            {{ old('auditee_id', $auditData->auditee_id) == $AuditeeName->auditee_id ? 'selected' : null }}>
                    ...
                    <div class="ContentTable">
                                ...
                                <select name="location_id" id="location_id" class="sh-tx" required>
                                    ...
                                    @foreach ($AuditLocNames as $AuditLoc)
                                        <option value="{{ $AuditLoc->location_id }}"
                                            {{ old('location_id', $auditData->location_id) == $AuditLoc->location_id ? 'selected' : null }}>
                        ...
                        <div class="column">
                            ...
                            <p><input type="text" name="audit_nature" id="audit_nature" class="sh-tx"
                                    value="{{ old('audit_nature', $auditData->audit_nature) }}"></p>
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="audit_type" id="audit_type" class="sh-tx"
                                    value="{{ old('audit_type', $auditData->audit_type) }}"></p>

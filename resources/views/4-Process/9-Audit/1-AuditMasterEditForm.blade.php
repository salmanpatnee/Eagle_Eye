        ...
        <div class="ContAssIndiTable">
            <div class="TableHeading">
                <div class="ButtonContainer">
                    ...
                    <button type="submit" type="button" onclick="showDeleteModal()"
            ...
            <form action="{{ route('audit-registrations.update', $audit->id) }}" method="post">
                @csrf
                @method('PATCH')
                    ...
                    <div class="ContentTableSection">
                        ...
                        <div class="ContentTable">
                            <div class="column">
                                ...
                                <p><input type="text" name="audit_id" id="audit_id" class="sh-tx"
                                        placeholder="Enter Audit ID" value="{{ old('audit_id', $audit->audit_id) }}"
                                        required readonly></p>
                            ...
                            <div class="column">
                                ...
                                <p><input type="text" name="audit_name" id="audit_name" class="sh-tx"
                                        placeholder="Write Audit Name"
                                        value="{{ old('audit_name', $audit->audit_name) }}" required></p>
                        ...
                        <div class="ContentTable">
                            <div class="column">
                                ...
                                <p><input type="text" name="audit_description" id="audit_description" class="bg-tx"
                                        placeholder="Write Audit Description"
                                        value="{{ old('audit_description', $audit->audit_description) }}">
                                </p>
                        ...
                        <div class="ContentTable">
                            <div class="column">
                                ...
                                <p><input type="text" name="audit_objectives" id="audit_objectives"
                                        class="bg-tx" placeholder="Write Audit Objectives"
                                        value="{{ old('audit_objectives', $audit->audit_objectives) }}">
                                </p>
                                    ...
                                    <select name="classification_id" id="classification_id" class="sh-tx" required>
                                        ...
                                        @foreach ($classNames as $className)
                                            <option value="{{ $className->classification_id }}"
                                                {{ $className->classification_id == old('classification_id', $audit->classification_id) ? 'selected' : '' }}>
                                    ...
                                    <select name="location_id" id="location_id" class="sh-tx" required>
                                        ...
                                        @foreach ($locNames as $locName)
                                            <option value="{{ $locName->location_id }}"
                                                {{ $locName->location_id == old('location_id', $audit->location_id) ? 'selected' : '' }}>
                        ...
                        <div class="ContentTable">
                            <div class="column">
                                ...
                                <p><input type="date" name="audit_start_date" id="audit_start_date"
                                        ...
                                        value="{{ old('audit_start_date', $audit->audit_start_date) }}"></p>
                            ...
                            <div class="column">
                                ...
                                <p><input type="date" name="audit_end_date" id="audit_end_date" class="sh-tx"
                                        required value="{{ old('audit_end_date', $audit->audit_end_date) }}"></p>
                        ...
                        <div class="ContentTable">
                            <div class="column">
                                ...
                                <p><input type="text" name="audit_type" id="audit_type" class="sh-tx"
                                        placeholder="Write Audit Type Name"
                                        value="{{ old('audit_type', $audit->audit_type) }}"></p>
                            ...
                            <div class="column">
                                ...
                                <select type="text" name="audit_internal_external" id="audit_internal_external"
                                    ...
                                    <option value="Internal"
                                        {{ old('audit_internal_external', $audit->audit_internal_external) == 'Internal' ? 'selected' : '' }}>
                                        Internal
                                    </option>
                                    <option value="External"
                                        {{ old('audit_internal_external', $audit->audit_internal_external) == 'External' ? 'selected' : '' }}>
                                        External
                                    </option>
                                </select>
                        ...
                        <div class="ContentTable">
                            <div class="column">
                                ...
                                <p><input type="text" name="auditing_entity" id="auditing_entity" class="sh-tx"
                                        ...
                                        value="{{ old('auditing_entity', $audit->auditing_entity) }}">
                                </p>
                                    ...
                                    <select name="auditor_id" id="auditor_id" class="sh-tx" required>
                                        ...
                                        @foreach ($auditorNames as $auditorName)
                                            <option value="{{ $auditorName->auditor_id }}"
                                                {{ old('auditor_id', $audit->auditor_id) == $auditorName->auditor_id ? 'selected' : '' }}>
                                                {{ $auditorName->auditor_id }}
                                            </option>
                                        @endforeach
                                    </select>
                                </p>
                        ...
                        <div class="ContentTable">
                            <div class="column">
                                ...
                                <p><input type="text" name="audit_scope" id="audit_scope" class="bg-tx"
                                        placeholder="Write Audit Scope"
                                        value="{{ old('audit_scope', $audit->audit_scope) }}"></p>
                        ...
                        <div class="ContentTable">
                            <div class="column">
                                ...
                                <p><input type="text" name="audit_approach" id="audit_approach" class="bg-tx"
                                        placeholder="Write Audit Approach"
                                        value="{{ old('audit_approach', $audit->audit_approach) }}"></p>
                                <x-error name="audit_scope" />
                            </div>
                        </div>
                        <div class="ContentTable">
                            <div class="column">
                                ...
                                <p><input type="text" name="standard_references" id="standard_references"
                                        ...
                                        value="{{ old('standard_references', $audit->standard_references) }}"></p>
                                    ...
                                    <select name="best_practice" id="best_practice" class="sh-tx" required>
                                        ...
                                        @foreach ($practNames as $practName)
                                            <option value="{{ $practName->best_practices_id }}"
                                                {{ old('best_practice', $audit->best_practice) == $practName->best_practices_id ? 'selected' : '' }}>

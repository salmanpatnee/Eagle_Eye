            ...
            <div class="ContentTableSection">
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $auditee->auditee_id }}</p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $auditee->auditee_first_name }}</p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <p class="sh-tx">{{ $auditee->auditee_last_name }}</p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $auditee->auditee_department }}</p>
                    </div>
                </div>
            </div>
        </table>

        ...
        <div class="ContentTableSection">
            ...
            <div class="ContentTable">
                <div class="column">
                    ...
                    <p class="sh-tx">{{ $auditFinding->audit->audit_id }}</p>
                </div>
                <div class="column">
                    <div class="MenuTxt">
                    ...
                    <p class="sh-tx">{{ $auditFinding->audit->audit_name }}</p>
                </div>
            </div>
            <div class="ContentTable">
                <div class="column">
                    ...
                    <p class="sh-tx">{{ $auditFinding->audit->bestPractice->best_practices_name }}</p>
                </div>
                <div class="column">
                    <div class="MenuTxt">
                        <h3>اسم الموقع</h3>
                    ...
                    <p class="sh-tx">{{ $auditFinding->audit->location?->location_name }}</p>
                </div>
            </div>
            <div class="ContentTable">
                <div class="column">
                    ...
                    <p class="sh-tx">{{ $auditFinding->audit->auditor->auditor_first_name }}
                        {{ $auditFinding->audit->auditor->auditor_last_name }}</p>
                </div>
                <div class="column">
                    <div class="MenuTxt">
                        <h3>اسم التصنيف</h3>
                    ...
                    <p class="sh-tx">{{ $auditFinding->audit->classification->classification_name }}</p>
                </div>
            </div>
        </div>
    </div>

    <form action="{{ route('audit-findings.update', $auditFinding->id) }}" method="POST">
        @csrf
        @method('PATCH')
        <div class="ContAssIndiTable">
            <div class="ContentTableSection">
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="audit_finding_id" id="audit_finding_id" class="sh-tx"
                                ...
                                value="{{ old('audit_finding_id', $auditFinding->audit_finding_id) }}" required
                                readonly></p>
                    ...
                    <div class="column">
                        ...
                        <p><input type="text" name="audit_finding_name" id="audit_finding_name" class="sh-tx"
                                ...
                                value="{{ old('audit_finding_name', $auditFinding->audit_finding_name) }}" required>
                        </p>
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="audit_finding_description" id="audit_finding_description"
                                ...
                                value="{{ old('audit_finding_description', $auditFinding->audit_finding_description) }}">
                        </p>
                    </div>
                </div>
                        ...
                        <select name="auditee_id" id="auditee_id" class="sh-tx" required>
                            ...
                            @foreach ($auditees as $auditee)
                                <option value="{{ $auditee->auditee_id }}"
                                    {{ old('auditee_id', $auditFinding->auditee_id) == $auditee->auditee_id ? 'selected' : null }}>
                        ...
                        <select name="department_id" id="department_id" class="sh-tx" required>
                            ...
                            @foreach ($departments as $department)
                                <option value="{{ $department->department_id }}"
                                    {{ old('department_id', $auditFinding->department_id) == $department->department_id ? 'selected' : null }}>
                ...
                <div class="ContentTable">
                        ...
                        <select name="domain_id" id="domain_id" class="sh-tx" required>
                            ...
                            @foreach ($domains as $domain)
                                <option value="{{ $domain->main_domain_id }}"
                                    {{ old('domain_id', $auditFinding->domain_id) == $domain->main_domain_id ? 'selected' : null }}>
                    ...
                    <div class="column">
                        ...
                        <p><input type="text" name="audit_nature" id="audit_nature" class="sh-tx"
                                placeholder="Write Audit Nature"
                                value="{{ old('audit_nature', $auditFinding->audit_nature) }}"></p>
                    </div>
                </div>
                        ...
                        <select name="owner_id" id="owner_id" class="sh-tx" required>
                            ...
                            @foreach ($owners as $owner)
                                <option value="{{ $owner->owner_role_id }}"
                                    {{ old('owner_id', $auditFinding->owner_id) == $owner->owner_role_id ? 'selected' : null }}>
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="compliance_level"
                                value="{{ old('compliance_level', $auditFinding->compliance_level) }}"
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="nca_remarks" id="nca_remarks" class="bg-tx"
                                value="{{ old('nca_remarks', $auditFinding->nca_remarks) }}"
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="root_cause_analysis" id="root_cause_analysis" class="bg-tx"
                                placeholder="Write Root Cause Analysis"
                                value="{{ old('root_cause_analysis', $auditFinding->root_cause_analysis) }}"></p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="corrective_action" id="corrective_action" class="sh-tx"
                                ...
                                value="{{ old('corrective_action', $auditFinding->corrective_action) }}"></p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="preventive_action" id="preventive_action"
                                value="{{ old('preventive_action', $auditFinding->preventive_action) }}"
                                class="sh-tx" placeholder="Write Preventive Action"></p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <select name="audit_finding_status" id="audit_finding_status" class="sh-tx" required>
                            ...
                            @foreach ($statues as $status)
                                <option value="{{ $status }}"
                                    {{ old('audit_finding_status', $auditFinding->audit_finding_status) == $status ? 'selected' : null }}>
                                    {{ $status }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="column">
                        ...
                        <p><input type="date" name="closure_expected_date" id="closure_expected_date"
                                ...
                                value="{{ old('closure_expected_date', $auditFinding->closure_expected_date) }}"></p>
                    </div>
                </div>
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="lesson_learned" id="lesson_learned" class="bg-tx"
                                placeholder="Write Lesson Learned"
                                value="{{ old('lesson_learned', $auditFinding->lesson_learned) }}"></p>
                    </div>
                </div>

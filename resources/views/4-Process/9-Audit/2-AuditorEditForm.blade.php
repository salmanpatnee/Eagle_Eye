...
<body>
    ...
    <div class="IndiTable">
        ...
        <form id="form" action="/auditor/{{ $auditor->id }}" method="post">
            @csrf
            @method('PATCH')
            <table cellspacing="0">
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="auditor_id" id="auditor_id" class="sh-tx"
                                    placeholder="Enter Auditor ID" required readonly
                                    value="{{ old('auditor_id', $auditor->auditor_id) }}"></p>
                        </div>
                    </div>
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="auditor_first_name" id="auditor_first_name" class="sh-tx"
                                    ...
                                    value="{{ old('auditor_first_name', $auditor->auditor_first_name) }}"></p>
                        </div>
                        <div class="column">
                            <div class="FieldHead">
                            ...
                            <p><input type="text" name="auditor_last_name" id="auditor_last_name" class="sh-tx"
                                    placeholder="Write Auditor Last Name"
                                    value="{{ old('auditor_last_name', $auditor->auditor_last_name) }}"></p>
                        </div>
                    </div>
                    <div class="ContentTablebg">
                        <div class="column">
                            ...
                            <p><input type="text" name="auditor_organization" id="auditor_organization"
                                    ...
                                    value="{{ old('auditor_organization', $auditor->auditor_organization) }}"></p>
                        </div>
                    </div>
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="tel" name="auditor_contact_number" id="auditor_contact_number"
                                    ...
                                    value="{{ old('auditor_contact_number', $auditor->auditor_contact_number) }}"></p>
                        </div>
                        <div class="column">
                            <div class="FieldHead">
                            ...
                            <p><input type="email" name="auditor_contact_email" id="auditor_contact_email"
                                    ...
                                    value="{{ old('auditor_contact_email', $auditor->auditor_contact_email) }}"></p>
                        </div>
                    </div>
                </div>
            </table>

...
<body>
    ...
    <div class="herosec">
        ...
        <div>
            <form action="{{ route('ecc-regulatory-summary.show') }}?controlAssessmentId={{ $controlAssessmentId }}">
                    ...
                    <div class="col">
                        ...
                        <select class="form-select" name="status" id="status" onchange="this.form.submit()">
                            ...
                            <option value="Implemented"
                                {{ old('status', request('status')) == 'Implemented' ? 'selected' : null }}>Implemented
                            </option>
                            <option value="Not Implemented"
                                {{ old('status', request('status')) == 'Not Implemented' ? 'selected' : null }}>Not
                                Implemented</option>
                            <option value="Partially Implemented"
                                {{ old('status', request('status')) == 'Partially Implemented' ? 'selected' : null }}>
                                Partially Implemented</option>
                            <option value="Not Applicable"
                                {{ old('status', request('status')) == 'Not Applicable' ? 'selected' : null }}>Not
                                Applicable</option>
                        </select>
                    </div>
                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($row->control_finding_id)
                                <a href="{{ route('control-assessment-findings.show', $row->control_finding_id) }}"
                                    target="_blank">
                                    {{ $row->control_finding_id }} - {{ $row->finding_name }}
                        </td>
                        </a>
                @endif

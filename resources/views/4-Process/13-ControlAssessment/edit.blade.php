...
<body>
    ...
    <div class="ContAssIndiTable">
        ...
        <form id="MasterForm"
            action="{{ route('control-assessments.update', $controlAssessment->control_assessment_id) }}"
            method="POST">
            @csrf
            @method('PUT')
            <table cellspacing="0">
                <div class="ContentTableSection">
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="control_assessment_id" id="control_assessment_id"
                                    ...
                                    value="{{ old('control_assessment_id', $controlAssessment->control_assessment_id) }}"
                                    readonly></p>
                        </div>
                        <div class="column">
                            <div class="FieldHead">
                            ...
                            <p><input type="text" name="control_assessment_name" id="control_assessment_name"
                                    ...
                                    value="{{ old('control_assessment_name', $controlAssessment->control_assessment_name) }}">
                            </p>
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="control_assessment_description"
                                    ...
                                    value="{{ old('control_assessment_description', $controlAssessment->control_assessment_description) }}">
                            </p>
                        </div>
                    </div>
                    <div class="ContentTable">
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="control_assessment_type" id="control_assessment_type"
                                    ...
                                    value="{{ old('control_assessment_type', $controlAssessment->control_assessment_type) }}">
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="column">
                            ...
                            <select class="sh-tx" name="control_assessment_internal_external"
                                ...
                                <option value="Internal"
                                    {{ $controlAssessment['control_assessment_internal_external'] == 'Internal' ? 'selected' : '' }}>
                                    Internal</option>
                                <option value="External"
                                    {{ $controlAssessment['control_assessment_internal_external'] == 'External' ? 'selected' : '' }}>
                                    External</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="control_assessment_approach"
                                    ...
                                    value="{{ old('control_assessment_approach', $controlAssessment['control_assessment_approach']) }}">
                            </p>
                        </div>
                    </div>
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="control_assessment_objectives"
                                    ...
                                    value="{{ old('control_assessment_objectives', $controlAssessment['control_assessment_objectives']) }}">
                            </p>
                        </div>
                    </div>
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="control_assessment_scope" id="control_assessment_scope"
                                    ...
                                    value="{{ old('control_assessment_scope', $controlAssessment['control_assessment_scope']) }}">
                            </p>
                        </div>
                    </div>
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="standard_references" id="standard_references"
                                    ...
                                    value="{{ old('standard_references', $controlAssessment['standard_references']) }}">
                            </p>
                        </div>
                    </div>
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p>
                                <select name="best_practices_id" id="best_practices_id" class="sh-tx" disabled>
                                    <option value="">Select Option</option>
                                    @foreach ($bestPractices as $bestPractice)
                                        <option value="{{ $bestPractice->best_practices_id }}"
                                            {{ old('best_practices_id', $controlAssessment['best_practices_id']) == $bestPractice->best_practices_id ? 'selected' : '' }}>
                            ...
                            <p>
                                <select name="location_id" id="location_id" class="sh-tx" ">
                                    ...
                                    <option value="{{ $location->location_id }}"
                                        {{ old('location_id', $controlAssessment['location_id']) == $location->location_id ? 'selected' : '' }}>
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p>
                                <select name="auditor_id" id="auditor_id" class="sh-tx" ">
                                    <option value="" disabled selected hidden>Select Option</option>
                                        @foreach ($auditors as $auditor)
                                    <option value="{{ $auditor->auditor_id }}"
                                        {{ $controlAssessment['auditor_id'] == $auditor->auditor_id ? 'selected' : '' }}>
                        ...
                        <div class="column">
                            ...
                            <p>
                                <select name="classification_id" id="classification_id" class="sh-tx" ">
                                    <option value="">Select Option</option>
                                        @foreach ($classifications as
                                    $classification)
                                    <option value="{{ $classification->classification_id }}"
                                        {{ old('classification_id', $controlAssessment['classification_id']) == $classification->classification_id ? 'selected' : '' }}>
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="control_assessing_entity" id="control_assessing_entity"
                                    ...
                                    value="{{ old('control_assessing_entity', $controlAssessment['control_assessing_entity']) }}">
                            </p>
                        </div>
                    </div>
            </table>

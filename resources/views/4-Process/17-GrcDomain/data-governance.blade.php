...
@section('content')
    <div class="parasec">
        ...
        <p>Data Governance is the framework for managing data's availability, usability, integrity, and security to ensure
            it meets organizational and regulatory requirements.</p>
    </div>
    <div class="linksec">
        <div class="rowsec">

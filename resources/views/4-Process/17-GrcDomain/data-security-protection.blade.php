...
@section('content')
    <div class="parasec">
        ...
        <p>Data Security and Protection involves safeguarding data from unauthorized access, breaches, and loss through encryption, access controls, and other security measures.</p>
    </div>
    <div class="linksec">
        <div class="rowsec">

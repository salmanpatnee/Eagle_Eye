...
<body>
    ...
    <form action="{{ route('control-assessment-findings.update', $controlAssessmentFinding->control_finding_id) }}"
        method="POST">
        @csrf
        @method('PUT')
        <div class="ContAssIndiTable">
            <div class="ContentTableSection">
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="control_finding_id" id="control_finding_id" class="sh-tx"
                                placeholder="Enter ID" readonly value="{{old('control_finding_id', $controlAssessmentFinding->control_finding_id)}}"></p>
                    ...
                    <div class="column">
                        ...
                        <p><input type="text" name="control_finding_name" id="control_finding_name" class="sh-tx"
                                placeholder="Enter Name" readonly value="{{old('control_finding_name', $controlAssessmentFinding->control_finding_name)}}"></p>
                ...
                <div class="ContentTable">
                        ...
                        <p>
                            <select name="control_id" id="control_dropdown" class="bg-tx" style="width: 480px !important;"
                                ...
                                @foreach ($controls as $control)
                                    <option value="{{ $control->control_id }}" {{$controlAssessmentFinding->control_id == $control->control_id ? 'selected' : ''}}>
                    ...
                    <div class="column">
                        ...
                        <x-modal-button modal_id="categoriesModal" label="Update Category" name="categories"
                            :data="isset($selectedCategoryIds)
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="control_finding_description" id="control_finding_description"
                                class="bg-tx" placeholder="Write Description" value="{{old('control_finding_description', $controlAssessmentFinding->control_finding_description)}}"></p>
                    </div>
                </div>
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <select name="control_implementation_status" id="control_implementation_status"
                            ...
                            <option value="Implemented" {{$controlAssessmentFinding->control_implementation_status == 'Implemented' ? 'selected' : ''}}>(Implemented) مطبق كليًا</option>
                            <option value="Not Implemented" {{$controlAssessmentFinding->control_implementation_status == 'Not Implemented' ? 'selected' : ''}}>(Not Implemented) غير مطبق</option>
                            <option value="Partially Implemented" {{$controlAssessmentFinding->control_implementation_status == 'Partially Implemented' ? 'selected' : ''}}>(Partially Implemented) مطبق جزئيًا</option>
                            <option value="Not Applicable" {{$controlAssessmentFinding->control_implementation_status == 'Not Applicable' ? 'selected' : ''}}>(Not Applicable) غير قابل للتطبيق</option>
                        </select>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <select name="control_maturity_level" id="control_maturity_level" class="sh-tx" required>
                            <option value="1" {{$controlAssessmentFinding->control_maturity_level == '1' ? 'selected' : ''}}>1 </option>
                            <option value="2" {{$controlAssessmentFinding->control_maturity_level == '2' ? 'selected' : ''}}>2 </option>
                            <option value="3" {{$controlAssessmentFinding->control_maturity_level == '3' ? 'selected' : ''}}>3</option>
                            <option value="4" {{$controlAssessmentFinding->control_maturity_level == '4' ? 'selected' : ''}}>4</option>
                            <option value="5" {{$controlAssessmentFinding->control_maturity_level == '5' ? 'selected' : ''}}>5</option>
                        </select>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="control_implementation_details"
                                ...
                                placeholder="Write Control Implementation Details" value="{{old('control_implementation_details', $controlAssessmentFinding->control_implementation_details)}}">
                        </p>
                    </div>
                </div>
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="control_maturity_justification"
                                ...
                                placeholder="Write Control Maturity Justification" value="{{old('control_maturity_justification', $controlAssessmentFinding->control_maturity_justification)}}"></p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="remarks" id="remarks" class="bg-tx"
                                placeholder="Write Control Assessment Remarks" value="{{old('remarks', $controlAssessmentFinding->remarks)}}"></p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="corrective_action" id="corrective_action" class="bg-tx"
                                placeholder="Write Corrective Action" value="{{old('corrective_action', $controlAssessmentFinding->corrective_action)}}"></p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="date" name="corrective_action_due_date" id="corrective_action_due_date" value="{{old('corrective_action_due_date', $controlAssessmentFinding->corrective_action_due_date)}}"
                                class="bg-tx"></p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="preventive_action" id="preventive_action" class="bg-tx"
                                placeholder="Write Preventive Action" value="{{old('preventive_action', $controlAssessmentFinding->preventive_action)}}"></p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="date" name="preventive_action_due_date" id="preventive_action_due_date" value="{{old('preventive_action_due_date', $controlAssessmentFinding->preventive_action_due_date)}}"
                                class="bg-tx"></p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="control_auditee_name" id="control_auditee_name"
                                class="sh-tx" placeholder="Write Control Assessment Auditee Name" value="{{old('control_auditee_name', $controlAssessmentFinding->control_auditee_name)}}"></p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <p><input type="text" name="control_auditee_department" id="control_auditee_department"
                                class="sh-tx" placeholder="Write Control Assessment Auditee Department Name" value="{{old('control_auditee_department', $controlAssessmentFinding->control_auditee_department)}}"></p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="control_auditee_system" id="control_auditee_system"
                                class="bg-tx" placeholder="Write Control Auditee System" value="{{old('control_auditee_system', $controlAssessmentFinding->control_auditee_system)}}"></p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p><input type="text" name="lesson_learned" id="lesson_learned"
                                class="bg-tx" placeholder="Write Control Auditee System" value="{{old('lesson_learned', $controlAssessmentFinding->lesson_learned )}}"></p>
                    </div>
                </div>
            </div>
            ...
            <div class="TableHeading">
                <div class="AssmentButtonContainer">
                    <button type="submit" class="FindAddMoreButton" {{ auth()->user()->can('manage-asset') ? null : disabled }} name="submit" value="exit"
                        ...
                        <p class="ButtonEngTxt">Updated</p>
                    </button>
                </div>
            </div>
        </div>
    ...
    <x-modal id="categoriesModal" title="Select Category" :data="$categories" :selectedvalues="isset($selectedCategoryIds) ? $selectedCategoryIds : []"

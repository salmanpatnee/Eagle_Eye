            ...
            <div class="ListTable">
                <table cellspacing="0">
                    ...
                    @foreach ($columns as $data)
                        <tr>
                            <td><input type="checkbox" name="selecteddelete[]" value="{{ $data->control_finding_id }}">
                            </td>
                            <td><a
                                    href="/control-assessment-finding-table/{{ $data->control_finding_id }}">{{ $data->control_finding_id }}</a>
                            </td>
                            <td>{{ $data->control_finding_name }}</td>
                            <td>{{ $data->control_implementation_status }}</td>
                        </tr>
                    @endforeach
                </table>
            </div>

                ...
                <tbody class="tablebody">
                    ...
                    <tr style="border: 1px solid #000;">
                            ...
                            <td style="border: 1px solid #000; padding: 12px; font-size: 12px; text-align: left;">
                                <a href="{{ route('evidences.show', $row->evidence_id) }}" style="text-decoration: none;">
                                    {{ $row->evidence_id }}
                                </a>
                            </td>
                            <td style="border: 1px solid #000; padding: 12px; font-size: 12px; text-align: left;">
                            ...
                            <td style="border: 1px solid #000; padding: 12px; font-size: 12px; text-align: left; line-height: 2em;">

            ...
            <form id="form"
                ...
                <table cellspacing="0">
                    <div class="ContentTableSection">
                        ...
                        <div class="ContentTablebg">
                            <div class="column">
                                <x-input label="Organization Logo" label_ar="شعار الجهة" name="organization_logo"
                                    placeholder="Enter Organization Contact Number" type="file" :value="$organization?->organization_logo"
                                    class="bg-tx" />
                            </div>

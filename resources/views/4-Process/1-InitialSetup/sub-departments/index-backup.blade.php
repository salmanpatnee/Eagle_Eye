...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- CONTENT -->
        <div class="IndiTable">
            <form method="POST" action="{{ route('sub-departments.destroy') }}" id="deleteForm">
                @csrf
                @method('DELETE')
                ...
                <div class="TableHeading">
                    ...
                    <div class="ButtonContainer">
                        ...
                        <a href="{{ route('sub-departments.create') }}"
                        ...
                        <table cellspacing="0">
                            <tr class="table-header">
                                ...
                                <th style="padding-right: 0px;">
                                    ...
                                    <p class="ListHeadEngTxt">Sub-Department IDs</p>
                                </th>
                                <th style="padding-right: 100px;">
                                    <p class="ListHeadArbTxt">اسم القسم الفرعي</p>
                                    <p class="ListHeadEngTxt">Sub-Department Names</p>
                                </th>
                                <th style="padding-right: 100px;">
                                    <p class="ListHeadArbTxt">القسم</p>
                                    <p class="ListHeadEngTxt">Deparment</p>
                                </th>
                            </tr>
                            @foreach ($subDepartments as $subDepartment)
                                <tr>
                                    <td>
                                        <input type="radio" name="record" class="record" value="{{ $subDepartment->id }}"
                                        required>
                                    </td>
                                    <td>{{ $loop->index + 1}}</td>
                                    <td><a
                                            href="{{route('sub-departments.show', $subDepartment->id)}}">{{ $subDepartment->sub_department_id }}</a>
                                    </td>
    ...
    <script>
        document.getElementById('btnUpdate').addEventListener('click', function(event) {
            ...
            if (selectedRadio) {
                window.location.href = `/sub-departments/edit/${selectedRadio.value}`;
            } else {

            ...
            <table cellspacing="0">
                <div class="ContentTableSection">
                    <div class="ContentTable">
                        <div class="column">
                            <div class="FieldHead">
                                <p class="FieldHeadEngTxt">Sub-Category ID</p>
                                <p class="FieldHeadArbTxt">رمز الفئة الفرعية</p>
                            </div>
                            <p class="sh-tx">{{ $subCategory->sub_category_id }}</p>
                        </div>
                        <div class="column">
                            <div class="FieldHead">
                                <p class="FieldHeadEngTxt">Sub-Category Name</p>
                                <p class="FieldHeadArbTxt">اسم الفئة الفرعية</p>
                            </div>
                            <p class="sh-tx">{{ $subCategory->sub_category_name }}</p>
                        </div>
                    </div>
                    <div class="ContentTablebg">
                        <div class="column">
                            <div class="FieldHead">
                                <p class="FieldHeadEngTxt">Sub-Category Description</p>
                                <p class="FieldHeadArbTxt">وصف الفئة الفرعية</p>
                            </div>
                            <p class="bg-tx">{{ $subCategory->sub_category_description }}</p>
                        </div>
                    </div>
                    <div class="ContentTablebg">
                        <div class="column">
                            ...
                            <p class="bg-tx">{{ $subCategory->category->category_name }}
                            </p>
                        </div>
                    </div>
                </div>

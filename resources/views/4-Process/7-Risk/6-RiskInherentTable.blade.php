        ...
        <div class="TableHeading">
            ...
            <div class="ButtonContainer">
                ...
                <form method="POST" action="{{ route($routeName . '.delete') }}" id="deleteForm">
                    <input type="hidden" name="record" value="{{ $data->risk_inherent_id }}">
            ...
            <div class="ContentTableSection">
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $risk_inherent_id->risk_inherent_id }}</p>
                    </div>
                </div>
                <div class="ContentTablebg">
                    <div class="column">
                        ...
                        <p class="bg-tx">{{ $risk_inherent_id->risk_inherent_description }}</p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $risk_inherent_id->risk_appetite_name }}</p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $risk_inherent_id->risk_inherent_impact }}</p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <p class="sh-tx">{{ $risk_inherent_id->risk_inherent_likelihood }}</p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $risk_inherent_id->risk_inherent_score }}</p>
                    </div>
                </div>
            </div>
        </table>

            ...
            <div class="ContentTableSection">
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $key_risk_indicator_id->key_risk_indicator_id }}</p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <p class="sh-tx">{{ $key_risk_indicator_id->key_risk_indicator_name }}</p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $key_risk_indicator_id->key_risk_indicator_source }}</p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                            <p class="FieldHeadEngTxt">KRI Value</p>
                            <p class="FieldHeadArbTxt">قيمة مؤشر المخاطر الرئيسية</p>
                        </div>
                        <p class="sh-tx">{{ $key_risk_indicator_id->key_risk_indicator_value }}</p>
                    </div>
                </div>
                <div class="ContentTablebg">
                    <div class="column">
                        ...
                        <p class="bg-tx">{{ $key_risk_indicator_id->key_risk_indicator_description }}</p>
                    </div>
                </div>
            </div>
        </table>

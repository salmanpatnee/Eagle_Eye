            ...
            <div class="ContentTableSection">
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $riskSubType->risk_sub_type_id }}</p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <p class="sh-tx">{{ $riskSubType->risk_sub_type_name }}</p>
                    </div>
                </div>
                <div class="ContentTablebg">
                    <div class="column">
                        ...
                        <p class="bg-tx">{{ $riskSubType->risk_sub_type_description }}</p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $riskSubType?->type?->risk_type_name }}</p>
                    </div>
                    <div class="column">

            ...
            <div class="ContentTableSection">
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $key_performance_indicatory_id->key_performance_indicatory_id }}</p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <p class="sh-tx">{{ $key_performance_indicatory_id->key_performance_indicatory_name }}</p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $key_performance_indicatory_id->key_performance_indicatory_source }}</p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <p class="sh-tx">{{ $key_performance_indicatory_id->key_performance_indicatory_value }}</p>
                    </div>
                </div>
                <div class="ContentTablebg">
                    <div class="column">
                        ...
                        <p class="bg-tx">{{ $key_performance_indicatory_id->key_performance_indicatory_description }}
                        </p>
                    </div>
                </div>
            </div>

            ...
            <div class="ContentTableSection">
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $risk_treatment_id->risk_treatment_id }}</p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <p class="sh-tx">{{ $risk_treatment_id->risk_treatment_name }}</p>
                    </div>
                </div>
                <div class="ContentTablebg">
                    <div class="column">
                        ...
                        <p class="bg-tx">{{ $risk_treatment_id->risk_treatment_description }}</p>
                    </div>
                </div>
            </div>
        </table>

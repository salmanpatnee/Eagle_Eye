...
<head>
    ...
    background-color: #6ba8b5!important;
        ...
        /* ul.align-items-center.d-flex.gap-2.navbar-nav img {
            width: 40px;
            height: 40px;
        } */
        /* #00ff89 */
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container-fluid">
                ...
                <div class="text-center d-flex gap-3">
                    <ul class="align-items-center d-flex gap-2 navbar-nav">
                        @foreach ($roles as $role)    
                            <li class="nav-item fs-6 nav-item rounded-circle p-2 {{$role->role_name == auth()->user()->role->role_name ? 'bg-white' : 'bg-info'}}">
                                
                                <img 
                                    src="/images/icons/{{$role->icon}}" 
                                    class="img-fluid" 
                                    width="70" 
                                    height="70" 
                                    alt="{{$role->role_name}}" 
                                    title="{{$role->role_name}} - {{$role->role_name_ar}}"
                                    class="p-2">
                            </li>
                        @endforeach
                        {{-- <li class="nav-item fs-6  nav-item border rounded-circle bg-white p-1">
                            <img src="/images/icons/manager.png" width="45" height="45" alt=""
                                title="Admin">
                        </li>
                        
                        <li class="nav-item fs-6  nav-item border rounded-circle bg-white p-2">
                            <img src="/images/icons/user.png" width="40" height="40" alt=""
                                class="P-2">
                        </li>
                        <li class="nav-item fs-6  nav-item border rounded-circle bg-white p-1">
                            <img src="/images/icons/operator.png" width="45" height="45" alt="">
                        </li> --}}
                    </ul>
                    <button class="btn btn-dark w-100" style="border-radius: 10px">

    ...
    <section>
        <header>
            <div class="Header">
                ...
                <div>
                    <button id="print" class="btn btn-info btn-turqouis btn-sm rounded rounded-5 text-black" data-filename="Evidence Summary by Domains">
        ...
        <div class="OCD" id="print-area">
            <div class="OCDVBC">
                <h3>Evidence Summary by Domains</h3>

    ...
    <section>
        <header>
            <div class="Header">
                ...
                <div>
                    <button id="print" class="btn btn-info btn-turqouis btn-sm rounded rounded-5 text-black" data-filename="NCA Sub Domains Compliance Status">
                                    ...
                                    if (dataset && dataset.data[dataIndex]) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(response) {
                                                if (response.length) {
                                                    $("h2#subdomain").text(`${dataPoint.id} - ${subDomainName}`);
                                                    let i = 1;

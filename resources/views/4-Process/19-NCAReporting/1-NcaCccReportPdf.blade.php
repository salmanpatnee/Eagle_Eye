    ...
    <div class="">
        ...
        <div class="table-responsive">
            <table class="customers">
                @include('4-Process/19-NCAReporting/0-Cscctableheads')
                <tbody>
                    @foreach ($eccreport as $row)
                        @if ($row->main_domain_id == 'NCA-CCC-1' && $row->sub_domain_id == 'NCA-CCC-1-1')
                            <tr>
                                @include('4-Process/19-NCAReporting/0-Cscctablerrows')
                            </tr>
                        @endif
                    @endforeach
                </tbody>
        ...
        <div class="domainSubdomain">
            ...
            <p class="maindomaintext">
                ضمان إدارة مخاطر الأمن السيبراني على نحو ممنهج يهدف إلى حماية الأصول
                المعلوماتية والتقنية للجهة، وذلك وفقًاً للسياسات والإج راءات التنظيمية
                للجهة والمتطلبات التشريعية والتنظيمية ذات العلاقة
            </p>
        </div>
        <div class="table-responsive">
        ...
        <div class="domainSubdomain">
            ...
            <p class="maindomaintext">
                التأكد من أن متطلبات الأمن السيبراني مضمنة في منهجية وإجراءات إدارة
                مشاريع الجهة لحماية السرية وسلامة الأصول المعلوماتية والتقنية للجهة
                ودقتها وتوافرها، وذلك وفقًاً للسياسات والإج راءات التنظيمية للجهة
                والمتطلبات التشريعية والتنظيمية ذات العلاقة
            </p>
        </div>
        <div class="table-responsive">
        ...
        <div class="domainSubdomain">
            ...
            <p class="maindomaintext">
                ضمان التأكد من أن برنامج الأمن السيبراني لدى الجهة يتوافق مع المتطلبات
        ...
        <div class="domainSubdomain">
            ...
            <p class="maindomaintext">
                ضمان التأكد من أن ضوابط الأمن السيبراني لدى الجهة مطبقة وتعمل وفقًاً
                للسياسات والإجراءات التنظيمية للجهة، والمتطلبات التشريعية والتنظيمية
                الوطنية ذات العلاقة، والمتطلبات الدولية المقرّة تنظيميًاً على الجهة
            </p>
        </div>
        <div class="table-responsive">
            <table class="customers">
        ...
        <div class="domainSubdomain">
            ...
            <p class="maindomaintext">
                ضمان التأكد من أن مخاطر ومتطلبات الأمن السيبراني المتعلقة بالعاملين
                )موظفين ومتعاقدين( في الجهة تعالج بفعالية قبل وأثناء وعند انتهاء/إنهاء
                عملهم، وذلك وفقًاً للسياسات والإجراءات التنظيمية للجهة، والمتطلبات
                التشريعية والتنظيمية ذات العلاقة
            </p>
        </div>
        <div class="table-responsive">
        ...
        <div class="domainSubdomain">
            ...
            <p class="maindomaintext">
                ضمان التأكد من أن العاملين بالجهة لديهم التوعية الأمنية اللازمة وعلى
                دراية بمسؤولياتهم في جال الأمن السيبراني. والتأكد من تزويد العاملين
                بالجهة بالمهارات والمؤهلات والدورات لتدريبية المطلوبة
            </p>
            <p class="maindomaintext">
                في مجال الأمن السيبراني حماية الأصول المعلوماتية والتقنية للجهة القيام
        ...
        <div class="domainSubdomain">
            ...
            <p class="maindomaintext">
                ضمان تحديد واكتشاف حوادث الأمن السيبراني في الوقت المناسب وإدارتها
                بشكل فعّال والتعامل مع تهديدات الأمن السيبراني استباقيًاً من أجل منع
                أو تقليل الآثار المترتبة على أعمال الجهة. مع مراعاة ما ورد في الأمر
        ...
        <div class="domainSubdomain">
            <p class="maindomain">(Sub Domain) المكون الفرعي</p>
            <p class="maindomaintext" style="font-weight: 600">٢-١٤ الأمن المادي</p>
            <p class="maindomaintext">
                ضمان حماية الأصول المعلوماتية والتقنية للجهة من الوصول المادي غير
                المصرح به والفقدان والسرقة والتخريب
            </p>
        </div>
        <div class="table-responsive">
            <table class="customers">
        ...
        <div class="domainSubdomain">
            ...
            <p class="maindomaintext">
                ضمان حماية أصول الجهة من مخاطر الأمن السيبراني المتعلقة بالأطراف
                الخارجية )بما في ذلك خدمات الإسناد لتقنية المعلومات" Outsourcing"
                والخدمات المدارة" Managed Services"(. وفقًاً للسياسات والإجراءات
        ...
        <div class="domainSubdomain">
            ...
            <p class="maindomaintext">
                ضمان معالجة المخاطر السيبرانية وتنفيذ متطلبات الأمن السيبراني للحوسبة
                السحابية والاستضافة بشكل ملائم وفعّال، وذلك وفقًاً للسياسات
                والإجــراءات التنظيمية للجهة، والمتطلبات التشريعية والتنظيمية والأوامر
                والقرارات ذات العلاقة. وضمان حماية الأصول المعلوماتية والتقنية للجهة
                على خدمات لحوسبة السحابية التي تتم استضافتها أو معالجتها أو إدارتها
                بواسطة أطراف خارجية
            </p>
        </div>
        <div class="table-responsive">
        ...
        <div class="domainSubdomain">
            ...
            <p class="maindomaintext">
                ضمان إدارة الأمن السيبراني بشكل سليم وفعال لحماية توافر وسلامة وسرية
                أصول الجهة المتعلقة بأجهزة وأنظمة التحكم الصناعي )OT/ICS( ضد الهجوم
                السيبراني )مثل الوصول غير المصرح به والتخريب والتجسس والتلاعب( بما
                يتماشى مع إستراتيجية الأمن السيبراني للجهة، وإدارة مخاطر الأمن
                السيبراني ،والمتطلبات التشريعية والتنظيمية ذات العلاقة، وكذلك
                المتطلبات الدولية المقرّة تنظيميًاً على الجهة والمتعلقة بالأمن
                السيبراني
            </p>
        </div>
        <div class="table-responsive">

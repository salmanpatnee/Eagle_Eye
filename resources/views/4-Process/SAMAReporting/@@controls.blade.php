...
@foreach ($report as $control)
    @if ($control->control_id == 'SAMA-CSF-3.1.2.1')
        <x-main-control id="3.1.2.1" details="{{ $control->control_description }}" details_ar="" :control="$control" />
    @endif
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.2.2.A')
        ...
        @endphp
        <x-main-control id="3.1.2.2" details="The cyber security strategy should be aligned with:" details_ar=""
            :status="$status" />

        <x-sub-control id="3.1.2.2.A" details="{{ $control->control_description }}" details_ar="" :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.1.2.2.B')
        <x-sub-control id="3.1.2.2.B" details="{{ $control->control_description }}" details_ar="" :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.1.2.2.C')
        <x-sub-control id="3.1.2.2.C" details="{{ $control->control_description }}" details_ar="" :control="$control" />
    @endif
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.2.3.A')
        ...
        @endphp
        <x-main-control id="3.1.2.3" details="3.	The cyber security strategy should address:" details_ar=""
            :status="$status" />

        <x-sub-control id="3.1.2.3.A" details="{{ $control->control_description }}" details_ar="" :control="$control" />
    @endif

    @if ($control->control_id == 'SAMA-CSF-3.1.2.3.B')
        <x-sub-control id="3.1.2.3.B" details="{{ $control->control_description }}" details_ar="" :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.1.2.3.C')
        <x-sub-control id="3.1.2.3.C" details="{{ $control->control_description }}" details_ar="" :control="$control" />
    @endif
@endforeach
...
@foreach ($report as $control)
    @if ($control->control_id == 'SAMA-CSF-3.1.3.1')
        <x-main-control id="3.1.3.1" details="{{ $control->control_description }}" details_ar="" :control="$control" />
    @endif
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.3.3.A')
        ...
        @endphp
        <x-main-control id="3.1.3.3" details="3.	The cyber security policy should be:" details_ar=""
            :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.3.4.A')
        @php
            $status = getParentStatus($report, 'SAMA-CSF-3.1.3.4.');
        @endphp
        <x-main-control id="3.1.3.4" details="example" details_ar="" :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.3.4.F.1')
        ...
        @endphp
        <x-main-control id="3.1.3.4.F" details="" details_ar="" :status="$status" />
...
@foreach ($report as $control)
    @if ($control->control_id == 'SAMA-CSF-3.1.4.1.A')
        @php
            $status = getParentStatus($report, 'SAMA-CSF-3.1.4.1.');
        @endphp
        <x-main-control id="3.1.4.1"
            details="The Board of Directors has the ultimate responsibility for cyber security, including:"
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.4.1.C.1')
        ...
        @endphp
        <x-main-control id="3.1.4.1.C"
            details="endorsing (after being approved by the cyber security committee):" details_ar=""
            :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.4.2.A')
        @php
            $status = getParentStatus($report, 'SAMA-CSF-3.1.4.2.');
        @endphp
        <x-main-control id="3.1.4.2" details="2.	The cyber security committee should be responsible for"
            details_ar="" :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.4.2.C.1')
        ...
        @endphp
        <x-main-control id="3.1.4.2.C" details="c.	approving, communicating, supporting and monitoring"
            details_ar="" :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.4.3.A')
        ...
        @endphp
        <x-main-control id="3.1.4.3" details="The senior management should be responsible for:" details_ar=""
            :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.4.4.E.1')
        ...
        @endphp
        <x-main-control id="3.1.4.4.E"
            details="the cyber security activities across the Member Organization, including" details_ar=""
            :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.4.4.G.1')
      ...
      @endphp
      <x-main-control id="3.1.4.4.G" details="proactively supporting other functions on cyber security, including"
                            details_ar="" :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.4.4.G.3')
        <x-sub-control id="3.1.4.G.3" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.5.2.A')
        ...
        <x-main-control id="3.1.5.2"
            details="2.	The Member Organization’s project management methodology should ensure that:" details_ar=""
            :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.6.5.A')
        ...
        @endphp
        <x-main-control id="3.1.6.5" details="The cyber security awareness program should at a minimum include"
            details_ar="" :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.6.6.A')
        ...
        @endphp
        <x-main-control id="3.1.6.6" details="The cyber security awareness program should be evaluated to:"
            details_ar="" :status="$status" />
...
@foreach ($report as $control)
    @if ($control->control_id == 'SAMA-CSF-3.1.7.1.A')
        ...
        @endphp
        <x-main-control id="3.1.7.1.A"
            details="Specialist or security-related skills training should be provided to staff in the Member Organization’s relevant functional area categories in line with their job descriptions, including:"
            details_ar="" :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.2.1.4.A')
        ...
        @endphp
        <x-main-control id="3.2.1.4.A"
            details="The cyber security risk management process should be documented and address:" details_ar=""
            :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.2.1.5.A')
        ...
        @endphp
        <x-main-control id="3.2.1.5.A"
            details="The cyber security risk management process should address the Member Organization’s information assets, including (but not limited to):"
            details_ar="" :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.2.1.6.A')
        ...
        @endphp
        <x-main-control id="3.2.1.6" details="The cyber security risk management process should be initiated:"
            details_ar="" :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.2.1.8.A')
        ...
        @endphp
        <x-main-control id="3.2.1.8" details="The cyber security risk management activities should involve:"
            details_ar="" :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.3.A')
        <x-main-control id="3.2.1.3.2.A" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.3.B.1')
        <x-main-control id="3.2.1.3.3.B.1" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.3.B.2')
        <x-main-control id="3.2.1.3.3.B.2" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    ...
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.5.A')
        <x-main-control id="3.2.1.3.5.A" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.5.B')
        <x-main-control id="3.2.1.3.5.B" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.5.C')
        <x-main-control id="3.2.1.3.5.C" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.6.A')
        <x-main-control id="3.2.1.3.6.A" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.6.B.1')
        <x-main-control id="3.2.1.3.6.B.1" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.6.B.2')
        <x-main-control id="3.2.1.3.6.B.2" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.6.B.3')
        <x-main-control id="3.2.1.3.6.B.3" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.6.C')
        <x-main-control id="3.2.1.3.6.C" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.6.D')
        <x-main-control id="3.2.1.3.6.D" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
        @if ($control->control_id == 'SAMA-CSF-3.2.1.3.6.C')
            <x-main-control id="3.2.1.3.6.C" details="{{ $control->control_description }}" details_ar=""
                :control="$control" />
...
@foreach ($report as $control)
    @if ($control->control_id == 'SAMA-CSF-3.2.2.1.A')
        ...
        @endphp
        <x-main-control id="3.2.2.1"
            details="1.	A process should be established for ensuring compliance with relevant regulatory requirements affecting cyber security across the Member Organization. The process of ensuring compliance should:"
            details_ar="" :status="$status" />
...
@if ($control->control_id == 'SAMA-CSF-3.2.3.1.A')
    ...
    @endphp
    <x-main-control id="3.2.3.1" details="The Member Organization should comply with:" details_ar=""
        :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.2.4.5.A')
        ...
        <x-main-control id="3.2.4.5"
            details="Cyber security review should be subject to follow-up reviews to check that:" details_ar=""
            :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.1.3.A')
        @php
            $status = getParentStatus($report, 'SAMA-CSF-3.3.1.3.');
        @endphp
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.2.3.A')
        ...
        @endphp
        <x-main-control id="3.3.2.3" details="The physical security process should include (but not limited to):"
            details_ar="" :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.3.3.A')
        ...
        @endphp
        <x-main-control id="3.3.3.3" details="The asset management process should include" details_ar=""
            :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.4.3.A')
        ...
        @endphp
        <x-main-control id="3.3.4.3" details="The cyber security architecture should include:" details_ar=""
            :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.5.4.A')
        @php
            $status = getParentStatus($report, 'SAMA-CSF-3.3.5.4.');
        @endphp
        <x-main-control id="3.3.5.4" details="The identity and access management policy should include:"
            details_ar="" :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.6.5.A')
        ...
        @endphp
        <x-main-control id="3.3.6.5" details="The application security standard should include:" details_ar=""
            :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.7.4.A')
        @php
            $status = getParentStatus($report, 'SAMA-CSF-3.3.7.4.');
        @endphp
        <x-main-control id="3.3.7.4" details="The change management process should include:" details_ar=""
            :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.8.6.A')
        @php
            $status = getParentStatus($report, 'SAMA-CSF-3.3.8.6.');
        @endphp
        <x-main-control id="3.3.8.6" details="The infrastructure security standard should include:" details_ar=""
            :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.9.4.A')
        ...
        @endphp
        <x-main-control id="3.3.9.4" details="The cryptographic security standard should include:" details_ar=""
            :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.10.4.A')
        ...
        @endphp
        <x-main-control id="3.3.10.4" details="The BYOD standard should include" details_ar=""
            :status="$status" />
...
@foreach ($report as $control)
    @if ($control->control_id == 'SAMA-CSF-3.3.13.1')
        <x-main-control id="CID" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.A')
        @php
            $status = getParentStatus($report, 'SAMA-CSF-3.3.13.4.');
        @endphp
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.B.6.G.3')
        <x-sub-control id="3.3.13.4.B.6.G.3" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif

    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.B.6.G.4')
        <x-sub-control id="3.3.13.4.B.6.G.4" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif

    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.B.6.G.5')
        <x-sub-control id="3.3.13.4.B.6.G.5" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif

    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.B.7')
        <x-main-control id="3.3.13.4.B.7" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif

    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.B.8')
        <x-main-control id="3.3.13.4.B.8" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif

    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.B.9')
        <x-main-control id="3.3.13.4.B.9" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif

    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.B.10')
        <x-main-control id="3.3.13.4.B.10" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif

    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.B.11')
        <x-main-control id="3.3.13.4.B.11" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif

    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.C.1')
        <x-main-control id="3.3.13.4.C.1" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.C.2')
        <x-main-control id="3.3.13.4.C.2" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.C.3')
        <x-main-control id="3.3.13.4.C.3" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif

    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.D.1')
        <x-main-control id="3.3.13.4.D.1" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.D.2')
        <x-main-control id="3.3.13.4.D.2" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.D.3')
        <x-main-control id="3.3.13.4.D.3" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif

    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.D.4')
        <x-main-control id="3.3.13.4.D.4" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif

    @if ($control->control_id == 'SAMA-CSF-3.3.13.4.D.5')
        <x-main-control id="3.3.13.4.D.5" details="{{ $control->control_description }}" details_ar=""
            :control="$control" />
    @endif
@endforeach
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.14.3.A')
        ...
        @endphp
        <x-main-control id="3.3.14.3"
            details="To support this process a security event monitoring standard should be defined, approved and implemented."
            details_ar="" :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.14.4.A')
        ...
        @endphp
        <x-main-control id="3.3.14.4"
            details="The security event management process should include requirements for:" details_ar=""
            :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.15.4.A')
        ...
        @endphp
        <x-main-control id="3.3.15.4"
            details="The security incident management process should include requirements for" details_ar=""
            :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.15.7.A')
        ...
        @endphp
        <x-main-control id="3.3.15.7"
            details="The Member Organization should submit a formal incident report ‘SAMA IT Risk Supervision’ after resuming operations, including the following incident details:"
            details_ar="" :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.16.3.A')
        ...
        @endphp
        <x-main-control id="3.3.16.3" details="The threat intelligence management process should include"
            details_ar="" :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.3.17.3.A')
        ...
        @endphp
        <x-main-control id="3.3.17.3" details="The vulnerability management process should include:"
            details_ar="" :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.4.1.4.A')
        ...
        @endphp
        <x-main-control id="3.4.1.4" details="These contract and vendor management processes should cover:"
            details_ar="" :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.4.1.5.A')
        ...
        @endphp
        <x-main-control id="3.4.1.5" details="The contract management process should cover requirements for:"
            details_ar="" :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.4.1.6.A')
        ...
        @endphp
        <x-main-control id="3.4.1.6"
            details="The vendor management process (i.e., service level management) should cover requirements for:"
            details_ar="" :status="$status" />
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.4.2.3.A')
        ...
        @endphp
        <x-main-control id="3.4.2.3" details="The outsourcing process should include:" details_ar=""
            :status="$status" />

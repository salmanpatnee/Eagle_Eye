...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.1.3.3.A')
        ...
        <x-sub-control id="3.1.3.3.A" details="{{ $control->control_description }}" details_ar="" :control="$control" />
    @endif
...
@foreach ($report as $control)
    ...
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.3.A')
        @php
            $status = getParentStatus($report, 'SAMA-CSF-3.2.1.3.3.');
        @endphp
        <x-main-control id="3.2.1.3.3" details="Accepting cyber security risks should include" details_ar=""
            :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.5.A')
        ...
        @endphp
        <x-main-control id="3.2.1.3.5" details="Avoiding cyber security risks should include" details_ar=""
            :status="$status" />
    ...
    @if ($control->control_id == 'SAMA-CSF-3.2.1.3.6.A')
        @php
            $status = getParentStatus($report, 'SAMA-CSF-3.2.1.3.6.');
        @endphp
        <x-main-control id="3.2.1.3.6"
            details="Applying cyber security controls to mitigate cyber security risks should include:" details_ar=""
            :status="$status" />

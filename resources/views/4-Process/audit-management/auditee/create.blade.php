    ...
    <div>
        ...
        <form action="{{ isset($auditee) ? route('auditees.update', $auditee->id) : route('auditees.store') }}"
            ...
            <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6">
                <x-form.grid-col>
                    <div>
                        <x-form.field label="Auditee ID" label_ar="رمز مراجع" name="auditee_id" required="true"
                ...
                <x-form.grid-col>
                    <div>
                        <x-form.field label="Auditee First Name" label_ar="مراجع الاسم الأول" name="auditee_first_name"
                            required="true" placeholder="Enter Auditee First Name" :value="$auditee?->auditee_first_name" />
                    </div>
                    <div>
                        <x-form.field label="Auditee Last Name" label_ar="مراجع الاسم الأخير" name="auditee_last_name"
                ...
                <x-form.grid-col>
                    <div>
                        <x-form.select label="Auditee Department" label_ar="مراجع القسم" name="auditee_department"
                ...
                <div class="flex justify-end">
                    <x-form.submit label="Auditee" label_ar="النوع الفرعي الأصل" :isUpdate="$auditee?->id" />
                </div>
            </div>
        </form>

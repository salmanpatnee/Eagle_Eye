...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="IndiTable">
            ...
            <form id="form"
                action="{{ isset($threatrating) ? route('threatrating.update', $threatrating->id) : route('threatrating.store') }}"
                method="POST">
                @csrf
                @if (isset($threatrating))
                    @method('PUT')
                    <input type="hidden" name="id" value="{{ $threatrating->id }}">
                @endif
                <table cellspacing="0">
                    <div class="ContentTableSection">
                        <div class="ContentTable">
                            <div class="column">
                                ...
                                <p><input type="text" name="threat_agent_rating_id" id="threat_agent_rating_id"
                                        class="sh-tx" placeholder="Enter Threat Agent Rating ID"
                                        value="{{ old('threat_agent_rating_id', $threatrating?->threat_agent_rating_id) }}"
                                        {{ $threatrating?->threat_agent_rating_id ? 'readonly' : '' }} required>
                                    @error('threat_agent_rating_id')
                            ...
                            <div class="column">
                                ...
                                <p><input type="text" name="threat_agent_rating_title" id="threat_agent_rating_title"
                                        class="sh-tx" placeholder="Enter Threat Agent Rating Title"
                                        value="{{ old('threat_agent_rating_title', $threatrating?->threat_agent_rating_title) }}"
                                        required>
                                    @error('threat_agent_rating_title')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </p>
                            </div>
                        ...
                        <div class="ContentTablebg">
                            <div class="column">
                                ...
                                <p><input type="text" name="threat_agent_rating_description"
                                        id="threat_agent_rating_description" class="bg-tx"
                                        placeholder="Write Threat Agent Rating Description"
                                        value="{{ old('threat_agent_rating_description', $threatrating?->threat_agent_rating_description) }}">
                                    @error('threat_agent_rating_description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </p>
                            </div>

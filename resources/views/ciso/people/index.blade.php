            ...
            <div class="expert-empty-state">
                <div class="expert-empty-inner">
                    ...
                    <div class="expert-empty-icon-wrap">
                        <svg class="expert-empty-icon" viewBox="0 0 64 64" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect x="8" y="14" width="48" height="6" rx="3" fill="currentColor"
                                opacity="1" />
                            <rect x="16" y="29" width="32" height="6" rx="3" fill="currentColor"
                                opacity="0.7" />
                            <rect x="24" y="44" width="16" height="6" rx="3" fill="currentColor"
                                opacity="0.4" />
                            <circle cx="52" cy="52" r="10" fill="none" stroke="currentColor"
                                stroke-width="3" />
                            <line x1="59" y1="59" x2="64" y2="64" stroke="currentColor"
            ...
            <div class="mt-6 md:hidden space-y-4 px-4 sm:px-6">
                @forelse ($humanResource as $row)
                    <div class="border border-gray-200 rounded-lg p-4 bg-white shadow-sm">
                        ...
                        <div
                            class="mt-3 pt-3 border-t border-gray-100 grid grid-cols-1 gap-3 sm:grid-cols-2 text-sm text-gray-700">
                            <div>
                                <p class="text-xs font-medium uppercase tracking-wide mb-1" style="color: #000000;">
                                    Certification</p>

...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/css/process/4-Reporting/1-misreporting.css') }}">
</head>
...
<body>
    ...
    <div class="IndiTable">
        ...
        <h1 style="text-align: center; line-height: 35px; color:#203864;">Report of Not-Implemented Controls</h1>

...
<body>
    ...
    <body>
        <div class="OCD">
            <div class="CSSOCDVBC">
                <h3>Cybersecurity Resilience Compliance Status</h3>
        ...
        <script>
            function initializeCharts() {
                // Bar Chart
                const xValuesBar = ["Cybersecurity Resilience Aspects of Business Continuity Management (BCM)"];
                const yValuesBar = [96, 100, 0]

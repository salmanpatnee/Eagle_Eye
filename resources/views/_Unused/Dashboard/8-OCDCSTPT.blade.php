...
<body>
    ...
    <body>
        <div class="OCD">
            <div class="CSSOCDVBC">
                <h3>Third-Party and Cloud Computing Cybersecurity Compliance Status</h3>
        ...
        <script>
            function initializeCharts() {
                // Bar Chart
                const xValuesBar = ["Third-Party Cybersecurity", "Cloud Computing and Hosting Cybersecurity"];
                const yValuesBar = [40, 60, 100, 0]
                const barColorsBar = ['#001F3F', "#002134"]

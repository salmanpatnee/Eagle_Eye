...
<body>
    ...
    <!-- CONTENT -->
    <div class="IndiTable">
        <form method="POST" action="{{ route('delete.certification') }}">
            @csrf
            @method('DELETE')
            <div class="TableHeading">
                <h1>Expert's Certification</h1>
                <div class="ButtonContainer">
                    <a href="" class="DisabledButton">View</a>
                    <a href="/expert-certification-input" class="MoreButton">Add</a>
            ...
            <div class="ListTable">
                <table cellspacing="0">
                    <tr>
                        ...
                        <th style="padding-right: 0px;">Certification ID</th>
                        <th style="padding-right: 100px;">Certification Name</th>
                    </tr>
                    @foreach ($columns as $data)
                        <tr>
                            <td><input type="checkbox" name="selecteddelete[]" value="{{ $data->certification_id }}">
                            </td>
                            <td><a
                                    href="/expert-certification-table/{{ $data->certification_id }}">{{ $data->certification_id }}</a>
                            </td>

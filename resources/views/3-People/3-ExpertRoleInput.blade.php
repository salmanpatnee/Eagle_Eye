...
<body>
    ...
    <!-- CONTENT -->
    <form action="/expert-role-input/post" method="post">
        @csrf
        <div class="IndiTable">
            <div class="TableHeading">
                <h1>Expert's Roles</h1>
                <div class="ButtonContainer">
                    <a href="/expert-role-list" class="MoreButton">View</a>
            ...
            <table cellspacing="0">
                <div class="ContentTableSection">
                    <div class="ContentTable">
                        <div class="column">
                            <h4>Expert Role ID</h4>
                            <p><input type="text" name="RoleId" id="RoleId" class="sh-tx"
                                    placeholder="Enter Role ID"></p>
                        </div>
                        <div class="column">
                            <h4>Expert Role Name</h4>
                            <p><input type="text" name="RoleName" id="RoleName" class="sh-tx"
                                    placeholder="Enter Role Name"></p>
                        </div>
                    </div>
                    <div class="ContentTable">
                        <div class="column">
                            <h4>Expert Role Description</h4>
                            <p><input type="text" name="RoleDes" id="RoleDes" class="bg-tx"
                                    placeholder="Enter Role Description"></p>
                        </div>
                    </div>
                </div>
            </table>

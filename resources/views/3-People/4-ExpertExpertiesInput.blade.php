...
<body>
    ...
    <form action="/expert-expertise-input/post" method="post">
        @csrf
        <div class="IndiTable">
            ...
            <table cellspacing="0">
                <div class="ContentTableSection">
                    <div class="ContentTable">
                        <div class="column">
                            <h4>Expertise ID</h4>
                            <p><input type="text" name="ExptiesId" id="ExptiesId" class="sh-tx"></p>
                        </div>
                        <div class="column">
                            <h4>Expertise Name</h4>
                            <p><input type="text" name="ExptiesName" id="ExptiesName" class="sh-tx"
                    ...
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="ExptiesDes" id="ExptiesDes" class="bg-tx"
                                    placeholder="Write Expert Description"></p>
                        </div>
                    </div>
                </div>
            </table>

            ...
            <div class="ContentTableSection">
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $location_id->expert_organization_id }}</p>
                    </div>
                    <div class="column">
                        <h4>Organization Name</h4>
                        <p class="sh-tx">{{ $location_id->expert_organization_name }}</p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        <h4>Organization Website URL</h4>
                        <p class="bg-tx">{{ $location_id->expert_organization_website_url }}</p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        <h4>Organization Phone Number</h4>
                        <p class="sh-tx">{{ $location_id->expert_organization_phone_number }}</p>
                    </div>
                    <div class="column">
                        <h4>Organization Email Address</h4>
                        <p class="sh-tx">{{ $location_id->expert_organization_email }}</p>
                    </div>
                </div>
            </div>
        </table>

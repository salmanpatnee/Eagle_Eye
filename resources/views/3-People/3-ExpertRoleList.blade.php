            ...
            <div class="ListTable">
                <table cellspacing="0">
                    <tr>
                        ...
                        <th style="padding-right: 0px;">Role ID</th>
                        <th style="padding-right: 100px;">Role Name</th>
                    </tr>
                    @foreach ($columns as $data)
                        <tr>
                            <td><input type="checkbox" name="selecteddelete[]" value="{{ $data->expert_role_id }}">
                            </td>
                            <td><a href="/expert-role-table/{{ $data->expert_role_id }}">{{ $data->expert_role_id }}</a>
                            </td>
                            <td>{{ $data->expert_role_name }}</td>
                        </tr>
                    @endforeach
                </table>
            </div>

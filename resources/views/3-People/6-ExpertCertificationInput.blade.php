...
<body>
    ...
    <form action="/expert-certification-input/post" method="post">
        @csrf
        <div class="IndiTable">
            <div class="TableHeading">
                <h1>Expert's Certification</h1>
                <div class="ButtonContainer">
                    <a href="/expert-certification-list" class="MoreButton">View</a>
                ...
                <div class="ContentTableSection">
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="CertId" id="CertId" class="sh-tx"></p>
                        </div>
                        <div class="column">
                            <h4>Certification Name</h4>
                            <p><input type="text" name="CertName" id="CertName" class="sh-tx"
                                    placeholder="Write Certification Name"></p>
                        </div>
                    </div>
                    <div class="ContentTable">
                        <div class="column">
                            <h4>Certification Institute</h4>
                            <p><input type="text" name="CertInst" id="CertInst" class="bg-tx"
                                    placeholder="Write Institute Name"></p>
                        </div>
                    </div>
                </div>
            </table>

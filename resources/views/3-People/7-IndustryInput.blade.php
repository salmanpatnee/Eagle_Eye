...
<body>
    ...
    <form action="/expert-industry-input/post" method="post">
        @csrf
        <div class="IndiTable">
            <div class="TableHeading">
                <h1>Industry Registrations</h1>
                <div class="ButtonContainer">
                    <a href="/expert-industry-list" class="MoreButton">View</a>
            ...
            <table cellspacing="0">
                <div class="ContentTableSection">
                    <div class="ContentTable">
                        <div class="column">
                            <h4>Industry ID</h4>
                            <p><input type="text" name="IndId" id="IndId" class="sh-tx"
                                    placeholder="Enter Industry ID"></p>
                        </div>
                        <div class="column">
                            <h4>Industry Name</h4>
                            <p><input type="text" name="IndName" id="IndName" class="sh-tx"
                                    placeholder="Write Industry Name"></p>
                        </div>
                    </div>
                    <div class="ContentTable">
                        <div class="column">
                            <h4>Industry Description</h4>
                            <p><input type="text" name="IndDes" id="IndDes" class="bg-tx"
                                    placeholder="Write Industry Description"></p>
                        </div>
                    </div>
                </div>
            </table>

...
<body>
    ...
    <form action="/expert-organization-input/post" method="post">
        @csrf
        <div class="IndiTable">
            <div class="TableHeading">
                <h1>Organization Registration</h1>
                <div class="ButtonContainer">
                    <a href="/expert-organization-list" class="MoreButton">View</a>
                ...
                <div class="ContentTableSection">
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="OrgId" id="OrgId" class="sh-tx"></p>
                        </div>
                        <div class="column">
                            <h4>Organization Name</h4>
                            <p><input type="text" name="OrgNames" id="OrgNames" class="sh-tx"
                                    placeholder="Write Orgnization Name"></p>
                        </div>
                    </div>
                    <div class="ContentTable">
                        <div class="column">
                            <h4>Organization Website URL</h4>
                            <p><input type="text" name="OrgUrl" id="OrgUrl" class="bg-tx"
                                    placeholder="Enter Orgnization Webiste Link"></p>
                        </div>
                    </div>
                    <div class="ContentTable">
                        <div class="column">
                            <h4>Organization Phone Number</h4>
                            <p><input type="text" name="OrgPhoneNum" id="OrgPhoneNum" class="sh-tx"
                                    placeholder="Enter Organization Phone Number"></p>
                        </div>
                        <div class="column">
                            <h4>Organization Email Address</h4>
                            <p><input type="text" name="OrgEmailAdd" id="OrgEmailAdd" class="sh-tx"
                                    placeholder="Enter Organization Email Address"></p>
                        </div>
                    </div>
                </div>
            </table>

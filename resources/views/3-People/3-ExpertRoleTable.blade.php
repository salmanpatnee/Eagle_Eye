    ...
    <div class="IndiTable">
        <div class="TableHeading">
            ...
            <div class="ButtonContainer">
                ...
                <a href="/expert-role-input" class="MoreButton">Add</a>
            ...
            <div class="ContentTableSection">
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $expert_role_id->expert_role_id }}</p>
                    </div>
                    <div class="column">
                        <h4>Expert Role Name</h4>
                        <p class="sh-tx">{{ $expert_role_id->expert_role_name }}</p>
                    </div>
                </div>
                <div class="ContentTable">
                    <div class="column">
                        <h4>Expert Role Description</h4>
                        <p class="sh-tx">{{ $expert_role_id->expert_role_description }}</p>
                    </div>
                </div>
            </div>
        </table>

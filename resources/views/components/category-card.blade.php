...
@php
    ...
    $iconMap = [
        ...
        'backup' =>
            '<path fill-rule="evenodd" d="M12 1.5c-4.97 0-9 1.79-9 4s4.03 4 9 4 9-1.79 9-4-4.03-4-9-4Z" clip-rule="evenodd" /><path d="M12 10.5c-4.97 0-9-1.79-9-4v3.375c0 2.21 4.03 4 9 4s9-1.79 9-4V6.5c0 2.21-4.03 4-9 4Z" /><path d="M12 14.875c-4.97 0-9-1.79-9-4V14.5c0 2.21 4.03 4 9 4s9-1.79 9-4v-3.625c0 2.21-4.03 4-9 4Z" /><path d="M12 19.5c-4.97 0-9-1.79-9-4v2c0 2.21 4.03 4 9 4s9-1.79 9-4v-2c0 2.21-4.03 4-9 4Z" />',
        'training' =>
            '<path d="M11.7 2.805a.75.75 0 0 1 .6 0A60.65 60.65 0 0 1 22.83 8.72a.75.75 0 0 1-.231 1.337 49.948 49.948 0 0 0-9.902 3.912l-.003.002-.34.18a.75.75 0 0 1-.707 0A50.88 50.88 0 0 0 7.5 12.174v-.224c0-.131.067-.248.172-.311a54.615 54.615 0 0 1 4.653-2.52.75.75 0 0 0-.65-1.352 56.123 56.123 0 0 0-4.78 2.589 1.858 1.858 0 0 0-.859 1.228 49.803 49.803 0 0 0-4.634-1.527.75.75 0 0 1-.231-1.337A60.653 60.653 0 0 1 11.7 2.805Z" /><path d="M13.06 15.473a48.45 48.45 0 0 1 7.666-3.282c.134 1.414.22 2.843.255 4.284a.75.75 0 0 1-.46.711 47.87 47.87 0 0 0-8.105 4.342.75.75 0 0 1-.832 0 47.87 47.87 0 0 0-8.104-4.342.75.75 0 0 1-.461-.71c.035-1.442.121-2.87.255-4.286a48.4 48.4 0 0 1 7.667 3.282 49.3 49.3 0 0 1 2.12-1.998Z" />',
        'communication' =>
        ...
        'information sharing' =>
            '<path fill-rule="evenodd" d="M15.75 4.5a3 3 0 1 1 .825 2.066l-8.421 4.679a3.002 3.002 0 0 1 0 1.51l8.421 4.679a3 3 0 1 1-.729 1.31l-8.421-4.678a3 3 0 1 1 0-4.132l8.421-4.679a3.023 3.023 0 0 1-.096-.755Z" clip-rule="evenodd" />',
        'authorities' =>
            '<path fill-rule="evenodd" d="M12.516 2.17a.75.75 0 0 0-1.032 0 11.209 11.209 0 0 1-7.877 3.08.75.75 0 0 0-.722.515A12.74 12.74 0 0 0 2.25 9.75c0 5.942 4.064 10.932 9.563 12.348a.749.749 0 0 0 .374 0c5.499-1.416 9.563-6.406 9.563-12.348 0-1.39-.223-2.73-.635-3.985a.75.75 0 0 0-.722-.516l-.143.001c-2.996 0-5.717-1.17-7.734-3.08Zm3.094 8.016a.75.75 0 1 0-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 0 0-1.06 1.06l2.25 2.25a.75.75 0 0 0 1.14-.094l3.75-5.25Z" clip-rule="evenodd" />',
        'hr framework' =>
        ...
        'vulnerability' =>
            '<path fill-rule="evenodd" d="M8.478 1.6a.75.75 0 0 1 .273 1.026 3.72 3.72 0 0 0-.425 1.121c.058.058.118.114.18.168A4.491 4.491 0 0 1 12 2.25a4.49 4.49 0 0 1 3.497 1.668 3.712 3.712 0 0 0-.178-.165 3.72 3.72 0 0 0-.425-1.126.75.75 0 1 1 1.3-.75c.373.647.586 1.38.586 2.163a4.4 4.4 0 0 1-.062.559A4.49 4.49 0 0 1 18 8.25a4.49 4.49 0 0 1-1.78 3.58l.26.26c.99.049 1.803.485 2.357 1.13a4.498 4.498 0 0 1 1.413 3.28.75.75 0 0 1-1.5 0c0-.893-.374-1.7-.97-2.27-.322-.305-.717-.517-1.15-.609l-2.727 2.727a2.25 2.25 0 0 1-3.182 0l-2.727-2.727c-.433.092-.828.304-1.15.61a3.001 3.001 0 0 0-.97 2.27.75.75 0 1 1-1.5 0c0-1.265.524-2.412 1.413-3.282.554-.644 1.367-1.08 2.358-1.128l.26-.26A4.49 4.49 0 0 1 6 8.251c0-1.26.518-2.4 1.353-3.216.028-.199.042-.402.042-.608 0-.78.213-1.51.582-2.153a.75.75 0 0 1 1.025-.273ZM12 3.75a2.994 2.994 0 0 0-2.165.905A2.99 2.99 0 0 0 9 6.927c0 .835.34 1.59.886 2.137l2.553 2.553a.75.75 0 0 0 1.06 0l2.554-2.553A3.016 3.016 0 0 0 17.25 4.66 2.994 2.994 0 0 0 12 3.75ZM10.19 18.22a.75.75 0 0 1 1.06 0l1.19 1.189 1.189-1.189a.75.75 0 0 1 1.061 1.06l-1.189 1.19 1.19 1.189a.75.75 0 1 1-1.062 1.06L12.44 21.53l-1.19 1.19a.75.75 0 0 1-1.06-1.061l1.19-1.189-1.19-1.19a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" />',
        'siem' =>
            '<path fill-rule="evenodd" d="M2.25 5.25a3 3 0 0 1 3-3h13.5a3 3 0 0 1 3 3V15a3 3 0 0 1-3 3h-3v.257c0 .597.237 1.17.659 1.591l.621.622a.75.75 0 0 1-.53 1.28h-9a.75.75 0 0 1-.53-1.28l.621-.622a2.25 2.25 0 0 0 .659-1.59V18h-3a3 3 0 0 1-3-3V5.25Zm1.5 0v7.5a1.5 1.5 0 0 0 1.5 1.5h13.5a1.5 1.5 0 0 0 1.5-1.5v-7.5a1.5 1.5 0 0 0-1.5-1.5H5.25a1.5 1.5 0 0 0-1.5 1.5Z" clip-rule="evenodd" />',
        'network security' =>
            '<path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM6.262 6.072a8.25 8.25 0 1 0 10.562-.766 4.5 4.5 0 0 1-1.318 8.357A6.028 6.028 0 0 1 6.262 6.072ZM6.84 7.28A4.526 4.526 0 0 0 7.5 12a4.5 4.5 0 0 0 4.5 4.5c.136 0 .271-.006.404-.018a3 3 0 0 0 1.14-5.403A4.527 4.527 0 0 0 6.84 7.28ZM12 12a3 3 0 1 0-3-3c0 .85.353 1.617.92 2.163A1.5 1.5 0 0 1 12 12Z" clip-rule="evenodd" />',
        'ict project' =>
        ...
        'physical' =>
            '<path d="M11.47 3.841a.75.75 0 0 1 1.06 0l8.69 8.69a.75.75 0 1 0 1.06-1.061l-8.689-8.69a2.25 2.25 0 0 0-3.182 0l-8.69 8.69a.75.75 0 1 0 1.061 1.06l8.69-8.689Z" /><path d="m12 5.432 8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75.75H5.625A1.875 1.875 0 0 1 3.75 19.875v-6.198a2.29 2.29 0 0 0 .091-.086L12 5.432Z" />',
        'identity' =>
            '<path fill-rule="evenodd" d="M4.5 3.75a3 3 0 0 0-3 3v10.5a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V6.75a3 3 0 0 0-3-3h-15Zm4.125 3a2.625 2.625 0 1 0 0 5.25 2.625 2.625 0 0 0 0-5.25ZM3.75 17.25a4.125 4.125 0 0 1 8.191-.593.75.75 0 0 1-.659.843 4.402 4.402 0 0 0-.532.064 4.101 4.101 0 0 0-3.14 2.054.75.75 0 0 1-.685.382H4.5a.75.75 0 0 1-.75-.75v-2Zm10.125-7.5a.75.75 0 0 1 .75-.75h3.75a.75.75 0 0 1 0 1.5h-3.75a.75.75 0 0 1-.75-.75Zm.75 2.25a.75.75 0 0 0 0 1.5h3.75a.75.75 0 0 0 0-1.5h-3.75Z" clip-rule="evenodd" />',
        'classification' =>
            '<path fill-rule="evenodd" d="M5.25 2.25a3 3 0 0 0-3 3v4.318a3 3 0 0 0 .879 2.121l9.58 9.581c.92.92 2.39.986 3.38.152l.094-.085 4.077-4.077a2.39 2.39 0 0 0-.067-3.474l-9.58-9.58a3 3 0 0 0-2.122-.879H5.25ZM6.375 7.5a1.125 1.125 0 1 0 0-2.25 1.125 1.125 0 0 0 0 2.25Z" clip-rule="evenodd" />',
        'supervisory fees' =>
            '<path d="M10.464 8.746c.227-.18.497-.311.786-.394v2.795a2.252 2.252 0 0 1-.786-.393c-.394-.313-.546-.681-.546-1.004 0-.323.152-.691.546-1.004ZM12.75 15.662v-2.824c.347.085.664.228.921.421.427.32.579.686.579.991 0 .305-.152.671-.579.991a2.534 2.534 0 0 1-.921.42Z" /><path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM12.75 6a.75.75 0 0 0-1.5 0v.816a3.836 3.836 0 0 0-1.72.756c-.712.566-1.153 1.39-1.153 2.303 0 .914.441 1.737 1.153 2.303.51.405 1.113.67 1.72.756v2.89a3.847 3.847 0 0 1-1.421-.588.75.75 0 1 0-.836 1.244c.612.411 1.372.71 2.257.777V18a.75.75 0 0 0 1.5 0v-.816a3.835 3.835 0 0 0 1.72-.756c.712-.566 1.153-1.39 1.153-2.303 0-.914-.441-1.737-1.153-2.303a3.835 3.835 0 0 0-1.72-.756V8.176a3.847 3.847 0 0 1 1.421.588.75.75 0 1 0 .836-1.244 5.348 5.348 0 0 0-2.257-.777V6Z" clip-rule="evenodd" />',
        'joint examination' =>
    ...
    foreach ($iconMap as $keyword => $svg) {
...
<div
    ...
    <div
        class="relative z-10 flex items-center justify-center w-20 h-20 mx-auto mb-8 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 shadow-xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 group-hover:bg-white/15">
        <div class="absolute inset-0 rounded-2xl bg-gradient-to-br from-white/20 to-transparent opacity-50"></div>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
            class="w-10 h-10 text-white relative z-10 drop-shadow-lg">
            {!! $iconSvg !!}
        </svg>
    </div>

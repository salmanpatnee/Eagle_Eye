...
@section('content')
    <div class="parasec">
        ...
        <p>
            A Statement of Applicability (SoA) is a document that outlines the controls from a specific standard, such as
            ISO 27001, and identifies which controls are applicable to the organization, along with the justification for

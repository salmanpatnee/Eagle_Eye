...
@section('content')
    <div class="parasec">
        ...
        <p>
            ...
            A Third-Party Security Framework is a set of guidelines, policies, and controls designed to assess, manage, and
            mitigate security risks associated with external vendors, partners, and service providers, ensuring that
            third-party relationships do not compromise an organization's data, systems, or overall security posture.

...
@section('content')
    <div class="parasec">
        ...
        <p>
            Risk treatment is the process of selecting and implementing measures to manage identified risks, which may
            involve mitigating, transferring, accepting, or avoiding the risks, in order to reduce their impact or
            likelihood to an acceptable level.</p>
    </div>
    <div class="linksec">
        <div class="rowsec">

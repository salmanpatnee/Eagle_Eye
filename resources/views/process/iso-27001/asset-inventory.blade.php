...
@section('content')
    <div class="parasec">
        ...
        <p>Asset inventory refers to the comprehensive list or record of all physical and digital assets within an
            organization, including hardware, software, data, and other resources, which are managed and tracked to ensure
            proper security, maintenance, and compliance.</p>
    </div>
    <div class="linksec">
        <div class="rowsec">

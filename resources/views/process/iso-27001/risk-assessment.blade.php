...
@section('content')
    <div class="parasec">
        ...
        <p>
            Risk assessment is the process of identifying, evaluating, and analyzing potential risks to an organization’s
            assets, operations, or objectives, in order to determine their likelihood and impact, and to develop strategies

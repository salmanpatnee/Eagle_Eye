    ...
    <div class="ContAssIndiTable">
        <div class="TableHeading">
            <div class="ButtonContainer">
                ...
                <a href="/risk-assessment-findings/create/{{ $riskAssessmentDetail->risk_assessment_id }}"
                    class="{{ auth()->user()->can('manage-asset') ? 'MoreButton' : 'DisabledButton' }}">
                    <p class="ButtonArbTxt">يضيف</p>
                    <p class="ButtonEngTxt">Add</p>
                </a>
                <a href="/risk-assessment-findings/edit/{{ $riskAssessmentDetail->risk_finding_id }}"
                    class="{{ auth()->user()->can('manage-asset') ? 'MoreButton' : 'DisabledButton' }}">
        ...
        <div class="ContentTableSection">
            ...
            <div class="ContentTable">
                ...
                <div class="column">
                    ...
                    <p class="sh-tx" style="background-color: {{ $riskAssessmentDetail->risk_appetite }}">
                        {{ $riskAssessmentDetail->risk_appetite }}</p>
                    </p>
                </div>
            </div>

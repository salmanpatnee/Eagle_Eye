...
@section('content')
    <div class="parasec">
        ...
        <p>Personal Data Protection involves safeguarding individuals' personal information from unauthorized access, use,
            or disclosure to ensure privacy and compliance with regulations.</p>
    </div>
    <div class="linksec">
        <div class="rowsec">

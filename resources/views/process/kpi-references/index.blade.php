...
@section('title', 'KPI References')
@section('title_ar', 'المراجع مؤشرات الأداء الرئيسية')
@section('content')
    <div>
        <x-table.action-wrapper title="KPI References">
                            ...
                            <div class="flex items-center justify-center mt-5">
                                <div class="text-center text-white">
                                    <span class="font-bold" lang="ar"
                                        dir="rtl">{{ $reference->category_name_ar }}</span>

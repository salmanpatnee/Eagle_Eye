            ...
            <div class="ContentTableSection">
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $kpi->category->category_name }}</p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <p class="sh-tx">{{ $kpi->bestPractice?->best_practices_name }}</p>
                    </div>
                </div>
                ...
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $kpi?->kpi_frequency_value }}</p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <p class="sh-tx">{{ $kpi?->kpi_frequency_unit }}</p>
                    </div>
                </div>

...
<body>
        ...
        <header>
            <div class="Header">
                ...
                <div class="ReportButtonContainer">
                    {{-- <a href="/osmacc-regulatory-summary">
    ...
    <div class="contentsection">
        <div>
            ...
            <p class="arabichead">الهيئة الوطنية للأمن السيبراني - حسابات وسائل التواصل الاجتماعي الخاصة بالمنظمة. ضوابط
                الأمن السيبراني</p>
            <p class="enghead" style="margin-top: 20px">Control Assessment Regulator Reports</p>
            <p class="enghead">National Cybersecurity Authority - Organization Social Media Accounts Cybersecurity
                Controls (NCA-OSMACC)</p>
        ...
        <div class="table-responsive">
            <table class="summaryreport">
                ...
                @foreach ($osmaccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-OSMACC-2021' &&
            ...
            <table class="summaryreport">
                ...
                @foreach ($osmaccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-OSMACC-2021' &&
                            $row->main_domain_id == 'NCA-OSMACC-1' &&
                            $row->sub_domain_id == 'NCA-OSMACC-1-2')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
            ...
            <table class="summaryreport">
                ...
                @foreach ($osmaccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-OSMACC-2021' &&
                            $row->main_domain_id == 'NCA-OSMACC-1' &&
                            $row->sub_domain_id == 'NCA-OSMACC-1-3')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
                ...
                @foreach ($osmaccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-OSMACC-2021' &&
                            ...
                            $row->sub_domain_id == 'NCA-OSMACC-2-1')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
            ...
            <table class="summaryreport">
                ...
                @foreach ($osmaccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-OSMACC-2021' &&
                            $row->main_domain_id == 'NCA-OSMACC-2' &&
                            $row->sub_domain_id == 'NCA-OSMACC-2-3')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
            ...
            <table class="summaryreport">
                ...
                @foreach ($osmaccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-OSMACC-2021' &&
                            $row->main_domain_id == 'NCA-OSMACC-2' &&
                            $row->sub_domain_id == 'NCA-OSMACC-2-4')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
            ...
            <table class="summaryreport">
                ...
                @foreach ($osmaccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-OSMACC-2021' &&
                            $row->main_domain_id == 'NCA-OSMACC-2' &&
                            $row->sub_domain_id == 'NCA-OSMACC-2-5')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
            ...
            <table class="summaryreport">
                ...
                @foreach ($osmaccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-OSMACC-2021' &&
                            $row->main_domain_id == 'NCA-OSMACC-2' &&
                            $row->sub_domain_id == 'NCA-OSMACC-2-6')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
        ...
        <div class="table-responsive">
            <table class="summaryreport">
                ...
                @foreach ($osmaccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-OSMACC-2021' &&
                            $row->main_domain_id == 'NCA-OSMACC-3' &&
                            $row->sub_domain_id == 'NCA-OSMACC-3-1')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif

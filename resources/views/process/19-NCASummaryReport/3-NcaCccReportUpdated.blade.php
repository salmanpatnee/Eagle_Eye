...
<body>
    ...
    <div class="contentsection">
        <div>
            ...
            <p class="arabichead">الهيئة الوطنية للأمن السيبراني - ضوابط الأمن السيبراني السحابي</p>
            <p class="enghead" style="margin-top: 20px">Control Assessment Regulator Reports</p>
            <p class="enghead">National Cybersecurity Authority - Cloud Cybersecurity Controls (NCA-CCC)</p>
        ...
        <div class="table-responsive">
            <table class="summaryreport">
                <tr>
                    @include('process/19-NCASummaryReport/1-NcaEccTableHeads')
                </tr>
                @foreach ($cccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-CCC-2020' &&
                            $row->main_domain_id == 'NCA-CCC-1' &&
                            $row->sub_domain_id == 'NCA-CCC-1-1')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
                @endforeach
            </table>
            ...
            <table class="summaryreport">
                ...
                @foreach ($cccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-CCC-2020' &&
                            $row->main_domain_id == 'NCA-CCC-2' &&
                            $row->sub_domain_id == 'NCA-CCC-2-10')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
            ...
            <table class="summaryreport">
                ...
                @foreach ($cccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-CCC-2020' &&
                            $row->main_domain_id == 'NCA-CCC-2' &&
                            $row->sub_domain_id == 'NCA-CCC-2-11')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
            ...
            <table class="summaryreport">
                ...
                @foreach ($cccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-CCC-2020' &&
                            $row->main_domain_id == 'NCA-CCC-2' &&
                            $row->sub_domain_id == 'NCA-CCC-2-12')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
            ...
            <table class="summaryreport">
                ...
                @foreach ($cccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-CCC-2020' &&
                            $row->main_domain_id == 'NCA-CCC-2' &&
                            $row->sub_domain_id == 'NCA-CCC-2-13')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
            ...
            <table class="summaryreport">
                ...
                @foreach ($cccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-CCC-2020' &&
                            $row->main_domain_id == 'NCA-CCC-2' &&
                            $row->sub_domain_id == 'NCA-CCC-2-14')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
            ...
            <table class="summaryreport">
                ...
                @foreach ($cccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-CCC-2020' &&
                            $row->main_domain_id == 'NCA-CCC-2' &&
                            $row->sub_domain_id == 'NCA-CCC-2-15')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
        ...
        <div class="table-responsive">
            <table class="summaryreport">
                ...
                @foreach ($cccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-CCC-2020' &&
                            $row->main_domain_id == 'NCA-CCC-3' &&
                            $row->sub_domain_id == 'NCA-CCC-3-1')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
        ...
        <div class="table-responsive">
            <table class="summaryreport">
                ...
                @foreach ($cccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-CCC-2020' &&
                            $row->main_domain_id == 'NCA-CCC-4' &&
                            $row->sub_domain_id == 'NCA-CCC-4-1')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif

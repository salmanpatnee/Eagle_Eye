...
<body>
    ...
    <div class="contentsection">
        <div>
            ...
            <p class="arabichead">الهيئة الوطنية للأمن السيبراني - ضوابط الأمن السيبراني للبيانات</p>
            <p class="enghead" style="margin-top: 20px">Control Assessment Regulator Reports</p>
            <p class="enghead">National Cybersecurity Authority - Data Cybersecurity Controls (NCA-DCC)</p>
        ...
        <div class="table-responsive">
            <table class="summaryreport">
                ...
                @foreach ($dccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-DCC-2022' &&
                            $row->main_domain_id == 'NCA-DCC-1' &&
                            $row->sub_domain_id == 'NCA-DCC-1-1')
                        <tr>
        ...
        <div class="table-responsive">
            <table class="summaryreport">
                ...
                @foreach ($dccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-DCC-2022' &&
                            $row->main_domain_id == 'NCA-DCC-2' &&
                            $row->sub_domain_id == 'NCA-DCC-2-1')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif
        ...
        <div class="table-responsive">
            <table class="summaryreport">
                ...
                @foreach ($dccsummaryreport as $row)
                    @if (
                        $row->best_practices_id == 'NCA-DCC-2022' &&
                            $row->main_domain_id == 'NCA-DCC-3' &&
                            $row->sub_domain_id == 'NCA-DCC-3-1')
                        <tr>
                            @include('process/19-NCASummaryReport/1-NcaEccTableRows')
                        </tr>
                    @endif

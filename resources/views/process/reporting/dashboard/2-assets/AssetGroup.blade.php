                                            ...
                                            success: function(response) {
                                                ...
                                                if (response.length) {
                                                    ...
                                                    response.forEach(row => {
                                                        ...
                                                        html +=
                                                            `<td><a href="/owners/${row.asset_owner_id}" >${row.asset_owner_name}</a></td>`;
                                                        html +=
                                                            `<td>${row.asset_custodians}</td>`;
                                                        html +=
                                                            `<td><a href="/risk-identification-table/${row.risk_id}" >${row.risk_name}</a></td>`;
                                                        html +=
                                                            `<td><a href="/owners/${row.risk_owner_id}" >${row.risk_owner_name}</a></td>`;
                                                        html +=
                                                        ...
                                                        // }
                                                        // html +=
                                                        //     `<td> <a href="/owners/${ownerNameId}" >${owner}</a></td>`;
                                                        // html +=

...
@section('content')
    <div>
        <x-table.action-wrapper title="Risk Related to Ecommerce Assets">
            <x-action.pdf-button route_name="mis-risk-e-commerce-assets.index" />
            ...
            <x-table.tbody>
                ...
                @forelse ($result as $row)
                    <tr>
                        ...
                        <x-table.td>{{ $row->risk_consequences }}</x-table.td>
                    </tr>
                @endforeach
            </x-table.tbody>
        </x-table.table>

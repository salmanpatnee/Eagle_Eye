...
@section('actions')
    <x-table.action-wrapper title="">
        <x-action.pdf-button route_name="ccc-regulatory-report.show" query_params="&cloudControlType=cst" />
        <x-action.excel-button route_name="ccc-regulatory-report.excel" query_params="?cloudControlType=cst" />

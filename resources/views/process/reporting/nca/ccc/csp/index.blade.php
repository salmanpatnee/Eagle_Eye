...
@section('title', 'NCA-CCC Assessment and Compliance Reports')
@section('title_ar', 'تقرير التقييم والامتثال NCA-CCC')

@section('content')

@section('actions')
    <x-table.action-wrapper title="">
        <x-action.pdf-button route_name="ccc-regulatory-report.show" query_params="&cloudControlType=csp" />
        <x-action.excel-button route_name="ccc-regulatory-report.excel" query_params="?cloudControlType=csp" />
...
@section('report-info')
    ...
    <p class="text-lg text-gray-900 mb-0">National Cybersecurity Authority - Cloud Cybersecurity Controls (NCA-CCC CSP)</p>
@endsection
            ...
            <tbody>
                ...
                @foreach ($report as $control)
                    @if ($control->control_id == 'NCA-CCC-1-1-P-1-1')
                        ...
                        <x-main-control-ccc main_domain="Cybersecurity Governance"
                            main_domain_ar="1- حوكمة الأمن السيبراني" main_domain_id="1-1"
                            sub_domain="(Cybersecurity Roles and Responsibilities)"
...
"
                    ...
                    @if ($control->control_id == 'NCA-CCC-1-4-P-2-1')
                        ...
                        <x-main-control-ccc main_domain="" main_domain_ar="" main_domain_id="" sub_domain=""
                            sub_domain_ar="" control_id="1-4-P-2"
                    ...
                    @if ($control->control_id == 'NCA-CCC-1-5-P-1')
                        <x-main-control-ccc main_domain="" main_domain_ar="" main_domain_id="1-5"
                            sub_domain="(Cybersecurity in Change Management)"
                            sub_domain_ar="الأمن السيبراني ضمن إدارة التغيير " control_id="1-5-P-1"
                    ...
                    @if ($control->control_id == 'NCA-CCC-1-5-P-2')
                        <x-main-control-ccc main_domain="" main_domain_ar="" main_domain_id="" sub_domain=""
                            sub_domain_ar="" control_id="1-5-P-2"
                    ...
                    @if ($control->control_id == 'NCA-CCC-1-5-P-3-1')
                        ...
                        @endphp
                        <x-main-control-ccc main_domain="" main_domain_ar="" main_domain_id="" sub_domain=""
                            sub_domain_ar="" control_id="1-5-P-3"
                    ...
                    @if ($control->control_id == 'NCA-CCC-2-1-P-1-1')
                        ...
                        @endphp
                        <x-main-control-ccc main_domain="(Cybersecurity Defense)"
                            main_domain_ar="2- تعزيز الأمن السيبراني " main_domain_id="2-1"
                            sub_domain="(Asset Management)" sub_domain_ar="إدارة الأصول" control_id="2-1-P-1"
                    ...
                    @if ($control->control_id == 'NCA-CCC-2-2-P-1-1')
                        ...
                        <x-main-control-ccc main_domain="" main_domain_ar="" main_domain_id="2-2"
                            sub_domain="(Identity and Access Management)"
                            sub_domain_ar="إدارة هويات الدخول والصلاحيات" control_id="2-2-P-1"
...
"
                    ...
                    @if ($control->control_id == 'NCA-CCC-2-3-P-1-2')
                        <x-sub-control-ccc control_id="2-3-P-1-2"
                            ...
                            description_ar="وضع ضمانات لمنع اختلاط بيانات (Data Commingling) المشتركين."
                            :control="$control" theme="bg-teal" />
                    @endif
...
"
                    ...
                    @if ($control->control_id == 'NCA-CCC-2-3-P-1-7')
                        <x-sub-control-ccc control_id="2-3-P-1-7"
                            ...
                            description_ar="اكتشاف ومنع التغييرات غير المصرح بها على البرامج والأنظمة."
                            :control="$control" theme="bg-teal" />
                    @endif
...
الخاصة بالمشتركين (Guest Environments)، والحماية فيما بينها."
                    ...
                    @if ($control->control_id == 'NCA-CCC-2-4-P-1-1')
                        ...
                        <x-sub-control-ccc control_id="2-4-P-1-1"
                            ...
                            description_ar="مراقبة الشبكات الداخلية والخارجية للكشف عن الأنشطة المشبوهة."
                            :control="$control" theme="bg-teal" />
                    @endif
                    ...
                    @if ($control->control_id == 'NCA-CCC-2-5-P-1-2')
                        <x-sub-control-ccc control_id="2-5-P-1-2"
                            description="Centralized mobile device security management"
                    ...
                    @if ($control->control_id == 'NCA-CCC-2-5-P-1-3')
                        <x-sub-control-ccc control_id="2-5-P-1-3" description="Screen locking for end user devices"
                            description_ar="قفل الشاشة لأجهزة المستخدمين (Screen Lock)." :control="$control"
                            theme="bg-teal" />
                    @endif
                    ...
                    @if ($control->control_id == 'NCA-CCC-2-9-P-1-1')
                        ...
                        <x-main-control-ccc main_domain="" main_domain_ar="" main_domain_id="2-9"
                            sub_domain="(Vulnerabilities Management)" sub_domain_ar="إدارة الثغرات "
                            control_id="2-9-P-1"
                    ...
                    @if ($control->control_id == 'NCA-CCC-2-15-P-3-1')
                        ...
                        <x-sub-control-ccc control_id="2-15-P-3-1"
                            ...
                            description_ar="تحديد ملاك لمفاتيح التشفير (Key Owner)." :control="$control"
                            theme="bg-teal" />
                    @endif
                    ...
                    @if ($control->control_id == 'NCA-CCC-2-15-P-3-3')
                        <x-sub-control-ccc control_id="2-15-P-3-3"
                            ...
                            description_ar="تفعيل سجلات الأحداث المتعلقة بمفاتيح التشفير، ومراقبتها."
                            :control="$control" theme="bg-teal" />
                    @endif
                    ...
                    @if ($control->control_id == 'NCA-CCC-2-17-P-1')
                        <x-main-control-ccc main_domain="" main_domain_ar="" main_domain_id="2-17"
                            sub_domain="(Storage Media Security)" sub_domain_ar="أمن وسائط التخزين "
                            control_id="2-17-P-1"
                    ...
                    @if ($control->control_id == 'NCA-CCC-2-17-P-3-2')
                        <x-sub-control-ccc control_id="2-17-P-3-2"
                            description="Using secure means when disposing of media"
                    ...
                    @if ($control->control_id == 'NCA-CCC-2-17-P-3-5')
                        <x-sub-control-ccc control_id="2-17-P-3-5"
                            ...
                            description_ar="الحفظ الآمن لأجهزة وسائط التخزين الخارجية." :control="$control"
                            theme="bg-teal" />
                    @endif
                    ...
                    @if ($control->control_id == 'NCA-CCC-3-1-P-1-1')
                        ...
                        <x-main-control-ccc main_domain="(Cybersecurity Resilience)"
                            ...
                            sub_domain_ar="جوانب صمود الأمن السيبراني في إدارة استمرارية الأعمال"
                            control_id="3-1-P-1-1"
                    ...
                    @if ($control->control_id == 'NCA-CCC-4-1-P-1-1')
                        ...
                        <x-main-control-ccc main_domain="(Third-Party Cybersecurity)"
                            ...
                            sub_domain_ar="الأمن السيبراني المتعلق بسلسلة الإمداد والأطراف الخارجية"
                            control_id="4-1-P-1-1"
                    ...
                    @if ($control->control_id == 'NCA-CCC-4-1-P-1-4')
                        <x-sub-control-ccc control_id="4-1-P-1-4"
                            ...
                            description_ar="يجب على الطرف الخارجي إدارة مخاطر الأمن السيبراني الخاصة به."
                            :control="$control" border_b="true" />
                    @endif
                @endforeach

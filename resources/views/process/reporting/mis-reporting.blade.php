...
@section('content')
    <div>
        ...
        <div class="col-span-12 space-y-6 xl:col-span-7 mb-6">
            <div class="flex flex-row justify-center gap-4 md:gap-6 px-4">

                <div class="max-w-[380px] flex-1">
                    <x-report-card link="#" title="Asset Smart Search"
                        title_ar="
                    البحث الذكي عن الأصول" />
                </div>
                <div class="max-w-[380px] flex-1">
                    <x-report-card link="#" title="Management by Exceptions (MBE)"
                        title_ar="إدارة بواسطة الاستثناءات" />
                </div>

            </div>
        </div>
        <h2 class="report-head">
            <span class="font-bold" lang="ar" dir="rtl">الأصول الحرجة</span>
            Critical Assets
        </h2>
        <div class="col-span-12 space-y-6 xl:col-span-7 mb-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6 px-4">
                <x-report-card link="#" title="List of Critical Assets" title_ar="قائمة الأصول الحرجة" />
                <x-report-card link="#" title="Risk Related to Critical Assets"
                    title_ar="المخاطر المتعلقة بالأصول الحرجة" />
                <x-report-card link="#" title="Controls Related to Critical Assets"
        ...
        <div class="col-span-12 space-y-6 xl:col-span-7 mb-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6 px-4">
                <x-report-card link="#" title="List of Cloud Assets" title_ar="قائمة الأصول الحساسة" />
                <x-report-card link="#" title="Risk Related to Cloud Assets"
                    title_ar="المخاطر المتعلقة بالأصول الحساسة" />
                <x-report-card link="#" title="Controls Related to Cloud Assets"
        ...
        <div class="col-span-12 space-y-6 xl:col-span-7 mb-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6 px-4">
                <x-report-card link="#" title="List of Telework Assets" title_ar="قائمة أصول العمل عن بعد" />
                <x-report-card link="#" title="Risk Related to Telework Assets"
                    title_ar="المخاطر المتعلقة  أصول العمل عن بعد" />
                <x-report-card link="#" title="Controls Related to Telework Assets"
        ...
        <div class="col-span-12 space-y-6 xl:col-span-7 mb-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6 px-4">
                <x-report-card link="#" title="List of Social Media Assets" title_ar="قائمة أصول التواصل الاجتماعي" />
                <x-report-card link="#" title="Risk Related to Social Media Assets"
                    title_ar="المخاطر المتعلقة  أصول التواصل الاجتماعي" />
                <x-report-card link="#" title="Controls Related to Social Media Assets"
        ...
        <div class="col-span-12 space-y-6 xl:col-span-7 mb-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6 px-4">
                <x-report-card link="#" title="List of Data Privacy Assets" title_ar="قائمة أصول خصوصية البيانات" />
                <x-report-card link="#" title="Risk Related to Data Privacy Assets"
                    title_ar="المخاطر المتعلقة  أصول خصوصية البيانات" />
                <x-report-card link="#" title="Controls Related to Data Privacy Assets"
        ...
        <div class="col-span-12 space-y-6 xl:col-span-7 mb-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6 px-4">
                <x-report-card link="#" title="List of PII Assets"
                    title_ar="قائمة معلومات تحديد الهوية الشخصية الأصول" />
                <x-report-card link="#" title="Risk Related to PII Assets"
                    title_ar="المخاطر المتعلقة  معلومات تحديد الهوية الشخصية الأصول" />
                <x-report-card link="#" title="Controls Related to PII Assets"
        ...
        <div class="col-span-12 space-y-6 xl:col-span-7 mb-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6 px-4">
                <x-report-card link="#" title="List of Payment Assets" title_ar="قائمة أصول الدفع" />
                <x-report-card link="#" title="Risk Related to Payment Assets"
                    title_ar="المخاطر المتعلقة  أصول الدفع" />
                <x-report-card link="#" title="Controls Related to Payment Assets"
        ...
        <div class="col-span-12 space-y-6 xl:col-span-7 mb-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6 px-4">
                <x-report-card link="#" title="List of PCI Data Security Standard Assets"
                    title_ar="قائمة معيار أمان بيانات صناعة بطاقات الدفع أصول" />
                <x-report-card link="#" title="Risk Related to PCI Data Security Standard Assets"
                    title_ar="المخاطر المتعلقة  معيار أمان بيانات صناعة بطاقات الدفع أصول" />
                <x-report-card link="#" title="Controls Related to PCI Data Security Standard Assets"
        ...
        <div class="col-span-12 space-y-6 xl:col-span-7 mb-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6 px-4">
                <x-report-card link="#" title="List of E-Commerce Assets"
                    title_ar="قائمة أصول التجارة الإلكترونية" />
                <x-report-card link="#" title="Risk Related to E-Commerce Assets"
                    title_ar="المخاطر المتعلقة  أصول التجارة الإلكترونية" />
                <x-report-card link="#" title="Controls Related to E-Commerce Assets"
        ...
        <div class="col-span-12 space-y-6 xl:col-span-7 mb-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6 px-4">
                <x-report-card link="#" title="List of E-Banking Assets"
                    title_ar="قائمة الأصول المصرفية الإلكترونية" />
                <x-report-card link="#" title="Risk Related to E-Banking Assets"
                    title_ar="المخاطر المتعلقة  الأصول المصرفية الإلكترونية" />
                <x-report-card link="#" title="Controls Related to E-Banking Assets"

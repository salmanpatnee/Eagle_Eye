            ...
            <x-slot:body>
                @foreach ($threatAgents as $threatAgent)
                    <tr>
                        ...
                        <x-table.td min-width="200px" max-width="400px">{{ $threatAgent->threat_agent_name }}</x-table.td>
                        <x-table.td>{{ $threatAgent?->rating?->threat_agent_rating_title }}</x-table.td>
                        <x-table.td min-width="200px" max-width="400px"><x-table-list :data="$threatAgent?->vectors" id_key=""

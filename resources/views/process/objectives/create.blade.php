                ...
                <div class="ContentTableSection">
                    <div class="ContentTable">
                        <div class="column">
                            ...
                            <p><input type="text" name="objective_id" id="objective_id" class="sh-tx"
                                    placeholder="Enter ID" value="{{ old('objective_id', $objective?->objective_id) }}"
                    ...
                    <div class="ContentTablebg">
                        <div class="column">
                            ...
                            <p><input type="text" name="objective" id="objective" class="bg-tx"
                                    placeholder="Write Objective"
                                    value="{{ old('objective', $objective?->objective) }}" required>
                            </p>
                        </div>
                    </div>

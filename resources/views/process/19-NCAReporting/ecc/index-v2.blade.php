...
@section('action-buttons')
    ...
    <a href="{{ route('ecc-regulatory-report.excel') }}?controlAssessmentId={{ $controlAssessmentId }}" class="ReportButton">
    ...
    <div>
        ...
        <div class="table-responsive">
            <table class="customers">
                <tr>
                    @include('process/19-NCAReporting/partials/head-cells')
                </tr>
                @foreach ($report as $row)
                    @if (
                        ...
                        <tr>
                            @include('process/19-NCAReporting/partials/cells')
                        </tr>
                    @endif
                @endforeach
            </table>

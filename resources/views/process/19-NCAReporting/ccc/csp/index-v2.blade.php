@extends('process/19-NCAReporting/partials/app')
@section('action-buttons')
    ...
    <a
        href="{{ route('ccc-regulatory-report.excel') }}?controlAssessmentId={{ $controlAssessmentId }}&cloudControlType={{ $cloudControlType }}">
        <button class="ReportButton">
    ...
    <div>
        ...
        <div class="table-responsive">
            <table class="customers">
                <tr>
                    @include('process/19-NCAReporting/cscc/head-cells')
                </tr>
                @foreach ($report as $row)
                    @if ($row->main_domain_id == 'NCA-CCC-1' && $row->sub_domain_id == 'NCA-CCC-1-1')
                        <tr>
                            @include('process/19-NCAReporting/cscc/cells')
                        </tr>
                    @endif
                @endforeach
            </table>
        ...
        <div class="table-responsive">
            <table class="customers">
                ...
                @foreach ($report as $row)
                    @if ($row->main_domain_id == 'NCA-CCC-1' && $row->sub_domain_id == 'NCA-CCC-1-5')
                        <tr>
                            @include('process/19-NCAReporting/cscc/cells')
                        </tr>
                    @endif
        ...
        {{-- 2-16.WAS Cybersecurity Web Application Security --}}
        <div class="domainSubdomain">
            <p class="maindomain">(Sub Domain) المكون الفرعي</p>
            <p class="maindomaintext" style="font-weight: 600">
                أمن تطوير الأنظمة </p>
        ...
        <div class="table-responsive">
            <table class="customers">
                ...
                @foreach ($report as $row)
                    @if ($row->main_domain_id == 'NCA-CCC-2' && $row->sub_domain_id == 'NCA-CCC-2-16')
                        <tr>
                            @include('process/19-NCAReporting/cscc/cells')
                        </tr>
                    @endif
        ...
        <div class="domainSubdomain">
            ...
            <p class="maindomaintext" style="font-weight: 600">
                أمن وسائط التخزين </p>
            <p class="maindomaintext">
                ضمان التعامل الآمن مع المعلومات والبيانات عبر الوسائط المادية، لدى مقدم الخدمة. </p>
        </div>
        <div class="table-responsive">
            <table class="customers">
                <tr>
                ...
                @foreach ($report as $row)
                    @if ($row->main_domain_id == 'NCA-CCC-2' && $row->sub_domain_id == 'NCA-CCC-2-17')
                        <tr>
                            @include('process/19-NCAReporting/cscc/cells')
                        </tr>
                    @endif

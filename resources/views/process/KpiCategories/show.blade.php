    ...
    <div class="IndiTable">
        <div class="TableHeading">
            <div class="PageHead">
                ...
                <p class="PageHeadEngTxt">Key Performance Indicators Standard</p>
            </div>
            ...
            <div class="ContentTableSection">
                <div class="ContentTable">
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $category->kpi_id }}</p>
                    </div>
                    <div class="column">
                        <div class="FieldHead">
                        ...
                        <p class="sh-tx">{{ $category->kpi_name }}</p>
                    </div>
                </div>
                ...
                <div class="ContentTable">
                    ...
                    <div class="column">
                        ...
                        <p class="sh-tx">{{ $category->kpi_name_ar }}</p>
                    </div>
                    <div class="column">
                ...
                <div class="ContentTablebg">
                    <div class="column">
                        ...
                        <div class="bg-tx editor">
                            {!! html_entity_decode($category->conclusion) !!}
                        </div>
                        {{-- <p class="bg-tx">{{ $category->conclusion }} --}}
                        </p>
                    </div>
                </div>
            </div>

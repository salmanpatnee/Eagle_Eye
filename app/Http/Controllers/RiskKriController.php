...
class RiskKriController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('4-Process\risk-identification\kri\index', compact('keyRiskIndicators'));
    }

    public function show(KeyRiskIndicator $kri)
    {
        return view('4-Process\risk-identification\kri\show', compact('kri'));
    }

    public function create()
    {
        $kri = null;
        return view('4-Process\risk-identification\kri\create', compact('kri'));
    }

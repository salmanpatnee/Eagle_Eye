...
class CvssController extends Controller
{
    ...
    {
        $cvss = null;
        return view('process/6-Vulnerabilities/3-CvssForm', compact('cvss'));
    }
    ...
    public function index()
    {
        ...
        return view('process/6-Vulnerabilities/3-CvssList', compact('columns'));
    }
    ...
    public function show($cvss_id)
    {
        ...
        return view('process/6-Vulnerabilities/3-CvssTable', compact('cvss_id'));
    }
}

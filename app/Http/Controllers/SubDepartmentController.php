...
class SubDepartmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('process.1-InitialSetup.sub-departments.index', compact('subDepartments'));
    }

    public function show(SubDepartment $subDepartment)
    {
        $subDepartment->load('department');
        return view('process.1-InitialSetup.sub-departments.show', compact('subDepartment'));
    }
    ...
    public function create()
    {
        ...
        return view('process.1-InitialSetup.sub-departments.create', compact('subDepartment', 'departments'));
    }

...
class CustodianRoleController extends Controller
{
    public function index()
    {
        ...
        return view('process/initial-setup/custodian-roles/index', compact('custodianRoles'));
    }

    public function show(Custodian $custodianRole)
    {
        return view('process/initial-setup/custodian-roles/show', compact('custodianRole'));
    }

    public function create()
    {
        $custodianRole = null;
        return view('process/initial-setup/custodian-roles/create', compact('custodianRole'));
    }

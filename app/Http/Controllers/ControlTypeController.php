...
class ControlTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('4-Process\control-identification\control-types\index', compact('controlTypes'));
    }

    public function show(ControlType $controlType)
    {
        return view('4-Process\control-identification\control-types\show', compact('controlType'));
    }

    public function create()
    {
        $controlType = null;
        return view('4-Process\control-identification\control-types\create', compact('controlType'));
    }

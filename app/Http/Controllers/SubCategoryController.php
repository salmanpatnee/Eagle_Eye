...
class SubCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('process.1-InitialSetup.sub-categories.index', compact('subCategories'));
    }
    ...
    public function show(SubCategory $subCategory)
    {
        ...
        return view('process.1-InitialSetup.sub-categories.show', compact('subCategory'));
    }
    ...
    public function create()
    {
        ...
        return view('process.1-InitialSetup.sub-categories.create', compact('subCategory', 'categories'));
    }

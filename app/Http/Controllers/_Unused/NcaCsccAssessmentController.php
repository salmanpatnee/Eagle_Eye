...
class NcaCsccAssessmentController extends Controller
{
    ...
    public function index()
    {
        $data = DB::table('control_master_table as master')
            ...
            ->where('details.id', '!=', null)->where('master.best_practices_name', 'NCA-CSCC')
            ->get();


        return view('process/18-Reporting/1-RegulatoryReporting/3-NcaCsccAssessmentReport', ['data' => $data]);
    }

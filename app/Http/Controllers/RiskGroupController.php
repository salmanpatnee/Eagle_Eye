...
class RiskGroupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('4-Process\risk-identification\risk-groups\index', compact('riskGroups'));
    }

    public function show(RiskGroup $riskGroup)
    {
        return view('4-Process\risk-identification\risk-groups\show', compact('riskGroup'));
    }
    ...
    public function create()
    {
        ...
        return view('4-Process\risk-identification\risk-groups\create', compact('riskGroup', 'owners'));
    }

...
class RiskAssessmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('4-Process\assessments\risk-assessments\index', compact('riskAssessments', 'riskAssessmentNames', 'riskNames', 'riskAssessmentId', 'riskId', 'startEndDate'));
    }
    ...
    public function show(RiskAssessment $riskAssessment)
    {
        ...
        return view('4-Process\assessments\risk-assessments\show', compact('riskAssessment'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('4-Process\assessments\risk-assessments\create', compact('locations', 'auditors', 'classifications', 'riskAssessment'));
    }
